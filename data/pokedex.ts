export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	venusaur: {
		...
		types: ["Grass", "Poison"],
		gender: "M",
		baseStats: {hp: 100, atk: 72, def: 93, spa: 90, spd: 110, spe: 70},
		abilities: {0: "Overgrow", H: "Chlorophyll"},
		heightm: 2,
		weightkg: 100,
		color: "Green",
	...
	charizard: {
		...
		types: ["Fire", "Flying"],
		gender: "M",
		baseStats: {hp: 78, atk: 65, def: 76, spa: 109, spd: 80, spe: 129},
		abilities: {0: "Blaze", H: "Solar Power"},
		heightm: 1.7,
		weightkg: 90.5,
		color: "Red",
	...
	blastoise: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 70, atk: 101, def: 89, spa: 143, spd: 75, spe: 76},
		abilities: {0: "Torrent", H: "Rain Dish"},
		heightm: 1.6,
		weightkg: 85.5,
		color: "Blue",
	...
	butterfree: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 60, atk: 60, def: 50, spa: 90, spd: 80, spe: 73},
	...
	beedrill: {
		...
		types: ["Bug", "Poison"],
		gender: "M",
		baseStats: {hp: 68, atk: 120, def: 57, spa: 68, spd: 80, spe: 84},
	...
	pidgeot: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 89, atk: 80, def: 54, spa: 90, spd: 77, spe: 81},
		abilities: {0: "Keen Eye", 1: "Tangled Feet", H: "Big Pecks"},
		heightm: 1.5,
		weightkg: 39.5,
		color: "Brown",
	...
	raticate: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 55, atk: 70, def: 60, spa: 45, spd: 70, spe: 112},
		abilities: {0: "Run Away", 1: "Guts", H: "Hustle"},
		heightm: 0.7,
		weightkg: 18.5,
		color: "Brown",
	...
	fearow: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 95, def: 65, spa: 61, spd: 61, spe: 100},
		abilities: {0: "Keen Eye", H: "Sniper"},
		heightm: 1.2,
		weightkg: 38,
		color: "Brown",
	...
	arbok: {
		...
		types: ["Poison"],
		gender: "M",
		baseStats: {hp: 66, atk: 98, def: 69, spa: 72, spd: 79, spe: 82},
		abilities: {0: "Intimidate", 1: "Shed Skin", H: "Unnerve"},
		heightm: 3.5,
		weightkg: 65,
		color: "Purple",
	...
	raichu: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 65, atk: 76, def: 50, spa: 85, spd: 80, spe: 94},
		abilities: {0: "Static", H: "Lightning Rod"},
		heightm: 0.8,
		weightkg: 30,
		color: "Yellow",
	...
	sandslash: {
		...
		name: "Sandslash",
		types: ["Ground"],
		baseStats: {hp: 75, atk: 110, def: 100, spa: 50, spd: 76, spe: 65},
		abilities: {0: "Sand Veil", H: "Sand Rush"},
		heightm: 1,
		gender: "M",
		weightkg: 29.5,
	...
	nidoqueen: {
		...
		abilities: {0: "Poison Point", 1: "Rivalry", H: "Thick Fat"},
		heightm: 1.3,
		weightkg: 60,
		color: "Blue",
		prevo: "Nidorina",
	...
	nidoking: {
		...
		types: ["Poison", "Ground"],
		gender: "M",
		baseStats: {hp: 81, atk: 102, def: 79, spa: 88, spd: 77, spe: 85},
	...
	clefable: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 95, atk: 60, def: 75, spa: 95, spd: 90, spe: 60},
	...
	ninetales: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 70, atk: 67, def: 75, spa: 86, spd: 100, spe: 85},
		abilities: {0: "Flash Fire", H: "Drought"},
		heightm: 1.1,
		weightkg: 19.9,
		color: "Yellow",
	...
	wigglytuff: {
		...
		types: ["Normal", "Fairy"],
		gender: "M",
		baseStats: {hp: 99, atk: 60, def: 50, spa: 75, spd: 55, spe: 60},
	...
	vileplume: {
		...
		types: ["Grass", "Poison"],
		gender: "M",
		baseStats: {hp: 80, atk: 70, def: 85, spa: 110, spd: 90, spe: 55},
	...
	parasect: {
		...
		types: ["Bug", "Grass"],
		gender: "M",
		baseStats: {hp: 60, atk: 95, def: 69, spa: 67, spd: 80, spe: 55},
		abilities: {0: "Effect Spore", 1: "Dry Skin", H: "Damp"},
		heightm: 1,
		weightkg: 29.5,
		color: "Red",
	...
	venomoth: {
		...
		types: ["Bug", "Poison"],
		gender: "M",
		baseStats: {hp: 70, atk: 70, def: 65, spa: 91, spd: 76, spe: 88},
	...
	dugtrio: {
		...
		types: ["Ground"],
		gender: "M",
		baseStats: {hp: 20, atk: 93, def: 46, spa: 57, spd: 54, spe: 138},
		abilities: {0: "Sand Veil", 1: "Arena Trap", H: "Sand Force"},
		heightm: 0.7,
		weightkg: 33.3,
		color: "Brown",
	...
	persian: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 65, atk: 70, def: 60, spa: 80, spd: 70, spe: 99},
	...
	golduck: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 80, atk: 96, def: 74, spa: 125, spd: 86, spe: 82},
		abilities: {0: "Damp", 1: "Cloud Nine", H: "Swift Swim"},
		heightm: 1.7,
		weightkg: 76.6,
		color: "Blue",
	...
	arcanine: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 80, atk: 81, def: 70, spa: 54, spd: 76, spe: 79},
		abilities: {0: "Intimidate", 1: "Flash Fire", H: "Justified"},
		heightm: 1.9,
		weightkg: 155,
		color: "Brown",
	...
	poliwrath: {
		...
		gender: "M",
		baseStats: {hp: 90, atk: 120, def: 95, spa: 113, spd: 101, spe: 50},
		abilities: {0: "Water Absorb", 1: "Damp", H: "Swift Swim"},
		heightm: 1.3,
		weightkg: 54,
		color: "Blue",
	...
	alakazam: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 60, atk: 94, def: 55, spa: 135, spd: 105, spe: 105},
		abilities: {0: "Synchronize", 1: "Inner Focus", H: "Magic Guard"},
		heightm: 1.5,
		weightkg: 48,
		color: "Brown",
	...
	machamp: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 90, atk: 130, def: 80, spa: 80, spd: 85, spe: 65},
		abilities: {0: "Guts", 1: "No Guard", H: "Steadfast"},
		heightm: 1.6,
		weightkg: 130,
		color: "Gray",
	...
	victreebel: {
		...
		types: ["Grass", "Poison"],
		gender: "M",
		baseStats: {hp: 89, atk: 70, def: 72, spa: 90, spd: 78, spe: 59},
		abilities: {0: "Chlorophyll", H: "Gluttony"},
		heightm: 1.7,
		weightkg: 15.5,
		color: "Green",
	...
	golem: {
		...
		types: ["Rock", "Ground"],
		gender: "M",
		baseStats: {hp: 80, atk: 120, def: 120, spa: 60, spd: 75, spe: 52},
		abilities: {0: "Rock Head", 1: "Sturdy", H: "Sand Veil"},
		heightm: 1.4,
		weightkg: 300,
		color: "Brown",
	...
	rapidash: {
		...
		name: "Rapidash",
		types: ["Fire"],
		baseStats: {hp: 68, atk: 80, def: 67, spa: 68, spd: 70, spe: 100},
		abilities: {0: "Run Away", 1: "Flash Fire", H: "Flame Body"},
		heightm: 1.7,
		weightkg: 95,
		gender: "M",
	...
	slowbro: {
		...
		types: ["Water", "Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 75, def: 110, spa: 80, spd: 90, spe: 29},
		abilities: {0: "Oblivious", 1: "Own Tempo", H: "Regenerator"},
		heightm: 1.6,
		weightkg: 78.5,
		color: "Pink",
	...
	farfetchd: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 60, atk: 88, def: 57, spa: 58, spd: 62, spe: 70},
	...
	dodrio: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 65, atk: 110, def: 70, spa: 60, spd: 70, spe: 102},
		abilities: {0: "Run Away", 1: "Early Bird", H: "Tangled Feet"},
		heightm: 1.8,
		weightkg: 85.2,
		color: "Brown",
	...
	dewgong: {
		...
		types: ["Water", "Ice"],
		gender: "M",
		baseStats: {hp: 88, atk: 88, def: 78, spa: 108, spd: 98, spe: 68},
		abilities: {0: "Thick Fat", 1: "Hydration", H: "Ice Body"},
		heightm: 1.7,
		weightkg: 120,
		color: "White",
	...
	muk: {
		...
		types: ["Poison"],
		gender: "M",
		baseStats: {hp: 95, atk: 111, def: 89, spa: 93, spd: 101, spe: 70},
		abilities: {0: "Stench", 1: "Sticky Hold", H: "Poison Touch"},
		heightm: 1.2,
		weightkg: 30,
		color: "Purple",
	...
	cloyster: {
		...
		types: ["Water", "Ice"],
		gender: "M",
		baseStats: {hp: 65, atk: 120, def: 155, spa: 110, spd: 50, spe: 69},
		abilities: {0: "Shell Armor", 1: "Skill Link", H: "Overcoat"},
		heightm: 1.5,
		weightkg: 132.5,
		color: "Purple",
	...
	gengar: {
		...
		types: ["Ghost", "Poison"],
		gender: "M",
		baseStats: {hp: 60, atk: 99, def: 60, spa: 130, spd: 84, spe: 100},
	...
	hypno: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 85, atk: 77, def: 75, spa: 93, spd: 105, spe: 72},
		abilities: {0: "Insomnia", 1: "Forewarn", H: "Inner Focus"},
		heightm: 1.6,
		weightkg: 75.6,
		color: "Yellow",
	...
	kingler: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 68, atk: 135, def: 88, spa: 107, spd: 70, spe: 75},
		abilities: {0: "Hyper Cutter", 1: "Shell Armor", H: "Sheer Force"},
		heightm: 1.3,
		weightkg: 60,
		color: "Red",
	...
	electrode: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 60, atk: 74, def: 83, spa: 80, spd: 88, spe: 80},
		abilities: {0: "Soundproof", 1: "Static", H: "Aftermath"},
		heightm: 1.2,
		weightkg: 66.6,
		color: "Red",
	...
	exeggutor: {
		...
		types: ["Grass", "Psychic"],
		gender: "M",
		baseStats: {hp: 90, atk: 60, def: 90, spa: 100, spd: 95, spe: 64},
		abilities: {0: "Chlorophyll", H: "Harvest"},
		heightm: 2,
		weightkg: 120,
		color: "Yellow",
	...
	marowak: {
		...
		types: ["Ground"],
		gender: "M",
		baseStats: {hp: 70, atk: 114, def: 110, spa: 68, spd: 87, spe: 54},
		abilities: {0: "Rock Head", 1: "Lightning Rod", H: "Battle Armor"},
		heightm: 1,
		weightkg: 45,
		color: "Brown",
	...
	hitmonlee: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 59, atk: 131, def: 67, spa: 53, spd: 129, spe: 131},
	...
	hitmonchan: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 67, atk: 84, def: 74, spa: 35, spd: 80, spe: 76},
	...
	weezing: {
		...
		types: ["Poison"],
		gender: "M",
		baseStats: {hp: 70, atk: 85, def: 115, spa: 105, spd: 71, spe: 68},
		abilities: {0: "Levitate", 1: "Neutralizing Gas", H: "Stench"},
		heightm: 1.2,
		weightkg: 9.5,
		color: "Purple",
	...
	kangaskhan: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 95, atk: 105, def: 80, spa: 40, spd: 80, spe: 90},
	...
	seaking: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 80, atk: 112, def: 65, spa: 95, spd: 80, spe: 83},
		abilities: {0: "Swift Swim", 1: "Water Veil", H: "Lightning Rod"},
		heightm: 1.3,
		weightkg: 39,
		color: "Red",
	...
	starmie: {
		...
		types: ["Water", "Psychic"],
		gender: "M",
		baseStats: {hp: 65, atk: 95, def: 90, spa: 121, spd: 95, spe: 95},
		abilities: {0: "Illuminate", 1: "Natural Cure", H: "Analytic"},
		heightm: 1.1,
		weightkg: 80,
		color: "Purple",
	...
	mrmime: {
		...
		types: ["Psychic", "Fairy"],
		gender: "M",
		baseStats: {hp: 40, atk: 50, def: 65, spa: 102, spd: 120, spe: 88},
	...
	scyther: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 45, def: 50, spa: 30, spd: 57, spe: 79},
	...
	jynx: {
		...
		types: ["Ice", "Psychic"],
		gender: "M",
		baseStats: {hp: 65, atk: 35, def: 35, spa: 80, spd: 100, spe: 85},
	...
	pinsir: {
		...
		gender: "M",
		types: ["Bug"],
		baseStats: {hp: 65, atk: 101, def: 100, spa: 55, spd: 70, spe: 85},
	...
	tauros: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 69, atk: 90, def: 73, spa: 40, spd: 73, spe: 99},
	...
	gyarados: {
		...
		types: ["Water", "Flying"],
		gender: "M",
		baseStats: {hp: 95, atk: 100, def: 81, spa: 45, spd: 100, spe: 115},
	...
	lapras: {
		...
		types: ["Water", "Ice"],
		gender: "M",
		baseStats: {hp: 98, atk: 107, def: 80, spa: 116, spd: 98, spe: 60},
	...
	jolteon: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 65, atk: 85, def: 60, spa: 90, spd: 85, spe: 130},
	...
	flareon: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 70, atk: 125, def: 70, spa: 110, spd: 95, spe: 85},
	...
	omastar: {
		...
		types: ["Rock", "Water"],
		gender: "M",
		baseStats: {hp: 60, atk: 100, def: 100, spa: 115, spd: 86, spe: 60},
		abilities: {0: "Swift Swim", 1: "Shell Armor", H: "Weak Armor"},
		heightm: 1,
		weightkg: 35,
		color: "Blue",
	...
	kabutops: {
		...
		types: ["Rock", "Water"],
		gender: "M",
		baseStats: {hp: 70, atk: 127, def: 110, spa: 103, spd: 70, spe: 87},
		abilities: {0: "Swift Swim", 1: "Battle Armor", H: "Weak Armor"},
		heightm: 1.3,
		weightkg: 40.5,
		color: "Brown",
	...
	aerodactyl: {
		...
		types: ["Rock", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 99, def: 65, spa: 60, spd: 72, spe: 142},
	...
	snorlax: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 130, atk: 123, def: 89, spa: 83, spd: 99, spe: 40},
	...
	articuno: {
		...
		types: ["Ice", "Flying"],
		gender: "M",
		baseStats: {hp: 100, atk: 107, def: 106, spa: 136, spd: 127, spe: 100},
	...
	zapdos: {
		...
		gender: "M",
		baseStats: {hp: 100, atk: 113, def: 94, spa: 140, spd: 116, spe: 127},
	...
	moltres: {
		...
		types: ["Fire", "Flying"],
		gender: "M",
		baseStats: {hp: 100, atk: 115, def: 96, spa: 148, spd: 105, spe: 115},
	...
	dragonite: {
		...
		types: ["Dragon", "Flying"],
		gender: "M",
		baseStats: {hp: 97, atk: 99, def: 94, spa: 65, spd: 99, spe: 76},
	...
	mewtwo: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 131, atk: 178, def: 136, spa: 178, spd: 136, spe: 131},
	...
	mewtwomegax: {
		...
		gender: "M",
		baseStats: {hp: 131, atk: 250, def: 155, spa: 180, spd: 155, spe: 140},
		abilities: {0: "Adaptability"},
		heightm: 2.5,
		weightkg: 203,
		color: "Purple",
	...
	mewtwomegay: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 131, atk: 180, def: 140, spa: 250, spd: 170, spe: 140},
		abilities: {0: "Psychic Surge"},
		heightm: 1.8,
		weightkg: 102,
		color: "Purple",
	...
	mew: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 107, spa: 130, spd: 115, spe: 110},
	...
	meganium: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 100, atk: 35, def: 100, spa: 45, spd: 125, spe: 56},
		abilities: {0: "Overgrow", H: "Leaf Guard"},
		heightm: 1.8,
		weightkg: 100.5,
		color: "Green",
	...
	typhlosion: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 78, atk: 92, def: 74, spa: 119, spd: 83, spe: 88},
		abilities: {0: "Blaze", H: "Flash Fire"},
		heightm: 1.7,
		weightkg: 79.5,
		color: "Yellow",
	...
	feraligatr: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 78, atk: 126, def: 90, spa: 114, spd: 83, spe: 78},
		abilities: {0: "Torrent", H: "Sheer Force"},
		heightm: 2.3,
		weightkg: 88.8,
		color: "Blue",
	...
	furret: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 60, atk: 55, def: 64, spa: 49, spd: 69, spe: 77},
		abilities: {0: "Run Away", 1: "Keen Eye", H: "Frisk"},
		heightm: 1.8,
		weightkg: 32.5,
		color: "Brown",
	...
	noctowl: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 75, atk: 50, def: 60, spa: 89, spd: 96, spe: 74},
		abilities: {0: "Insomnia", 1: "Keen Eye", H: "Tinted Lens"},
		heightm: 1.6,
		weightkg: 40.8,
		color: "Brown",
	...
	ledian: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 63, atk: 67, def: 64, spa: 72, spd: 80, spe: 69},
	...
	ariados: {
		...
		types: ["Bug", "Poison"],
		gender: "M",
		baseStats: {hp: 70, atk: 85, def: 70, spa: 60, spd: 70, spe: 48},
		abilities: {0: "Swarm", 1: "Insomnia", H: "Sniper"},
		heightm: 1.1,
		weightkg: 33.5,
		color: "Red",
	...
	crobat: {
		...
		types: ["Poison", "Flying"],
		gender: "M",
		baseStats: {hp: 85, atk: 97, def: 80, spa: 85, spd: 88, spe: 130},
		abilities: {0: "Inner Focus", H: "Infiltrator"},
		heightm: 1.8,
		weightkg: 75,
		color: "Purple",
	...
	lanturn: {
		...
		types: ["Water", "Electric"],
		gender: "M",
		baseStats: {hp: 97, atk: 85, def: 69, spa: 116, spd: 97, spe: 64},
		abilities: {0: "Volt Absorb", 1: "Illuminate", H: "Water Absorb"},
		heightm: 1.2,
		weightkg: 22.5,
		color: "Blue",
	...
	xatu: {
		...
		types: ["Psychic", "Flying"],
		gender: "M",
		baseStats: {hp: 65, atk: 70, def: 70, spa: 95, spd: 85, spe: 87},
		abilities: {0: "Synchronize", 1: "Early Bird", H: "Magic Bounce"},
		heightm: 1.5,
		weightkg: 15,
		color: "Green",
	...
	ampharos: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 115, atk: 43, def: 65, spa: 87, spd: 80, spe: 50},
		abilities: {0: "Static", H: "Plus"},
		heightm: 1.4,
		weightkg: 61.5,
		color: "Yellow",
	...
	bellossom: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 75, atk: 55, def: 85, spa: 90, spd: 100, spe: 98},
	...
	azumarill: {
		...
		types: ["Water", "Fairy"],
		gender: "M",
		baseStats: {hp: 120, atk: 70, def: 67, spa: 97, spd: 67, spe: 53},
		abilities: {0: "Thick Fat", 1: "Huge Power", H: "Sap Sipper"},
		heightm: 0.8,
		weightkg: 28.5,
		color: "Blue",
	...
	sudowoodo: {
		...
		types: ["Rock"],
		gender: "M",
		baseStats: {hp: 70, atk: 98, def: 107, spa: 40, spd: 73, spe: 55},
	...
	politoed: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 95, atk: 85, def: 70, spa: 95, spd: 95, spe: 78},
	...
	jumpluff: {
		...
		types: ["Grass", "Flying"],
		gender: "M",
		baseStats: {hp: 75, atk: 55, def: 68, spa: 65, spd: 95, spe: 94},
		abilities: {0: "Chlorophyll", 1: "Leaf Guard", H: "Infiltrator"},
		heightm: 0.8,
		weightkg: 3,
		color: "Blue",
	...
	sunflora: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 65, atk: 50, def: 60, spa: 95, spd: 85, spe: 60},
		abilities: {0: "Chlorophyll", 1: "Solar Power", H: "Early Bird"},
		heightm: 0.8,
		weightkg: 8.5,
		color: "Yellow",
	...
	quagsire: {
		...
		types: ["Water", "Ground"],
		gender: "M",
		baseStats: {hp: 95, atk: 121, def: 90, spa: 95, spd: 85, spe: 55},
		abilities: {0: "Damp", 1: "Water Absorb", H: "Unaware"},
		heightm: 1.4,
		weightkg: 75,
		color: "Blue",
	...
	espeon: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 67, atk: 63, def: 64, spa: 101, spd: 82, spe: 76},
	...
	umbreon: {
		...
		types: ["Dark"],
		gender: "M",
		baseStats: {hp: 80, atk: 60, def: 72, spa: 70, spd: 90, spe: 64},
	...
	slowking: {
		...
		types: ["Water", "Psychic"],
		gender: "M",
		baseStats: {hp: 95, atk: 87, def: 70, spa: 118, spd: 95, spe: 30},
		abilities: {0: "Oblivious", 1: "Own Tempo", H: "Regenerator"},
		heightm: 2,
		weightkg: 79.5,
		color: "Pink",
	...
	unown: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 50, atk: 70, def: 50, spa: 79, spd: 60, spe: 71},
		abilities: {0: "Levitate"},
		heightm: 0.5,
		weightkg: 5,
		color: "Black",
	...
	wobbuffet: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 90, atk: 81, def: 77, spa: 114, spd: 107, spe: 48},
	...
	girafarig: {
		...
		gender: "M",
		baseStats: {hp: 70, atk: 60, def: 67, spa: 84, spd: 77, spe: 77},
	...
	forretress: {
		...
		types: ["Bug", "Steel"],
		gender: "M",
		baseStats: {hp: 70, atk: 78, def: 85, spa: 50, spd: 85, spe: 56},
		abilities: {0: "Sturdy", H: "Overcoat"},
		heightm: 1.2,
		weightkg: 125.8,
		color: "Purple",
	...
	dunsparce: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 70, atk: 86, def: 73, spa: 68, spd: 77, spe: 50},
	...
	steelix: {
		...
		types: ["Steel", "Ground"],
		gender: "M",
		baseStats: {hp: 75, atk: 111, def: 135, spa: 65, spd: 81, spe: 83},
	...
	granbull: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 80, atk: 90, def: 75, spa: 50, spd: 75, spe: 65},
	...
	qwilfish: {
		...
		types: ["Water", "Poison"],
		gender: "M",
		baseStats: {hp: 65, atk: 100, def: 80, spa: 99, spd: 60, spe: 85},
	...
	scizor: {
		...
		types: ["Bug", "Steel"],
		gender: "M",
		baseStats: {hp: 70, atk: 91, def: 100, spa: 55, spd: 80, spe: 65},
	...
	shuckle: {
		...
		types: ["Bug", "Rock"],
		gender: "M",
		baseStats: {hp: 55, atk: 44, def: 200, spa: 34, spd: 200, spe: 5},
	...
	heracross: {
		...
		types: ["Bug", "Fighting"],
		gender: "M",
		baseStats: {hp: 75, atk: 119, def: 79, spa: 58, spd: 90, spe: 85},
	...
	ursaring: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 90, atk: 128, def: 75, spa: 81, spd: 76, spe: 59},
	...
	magcargo: {
		...
		gender: "M",
		types: ["Fire", "Rock"],
		baseStats: {hp: 70, atk: 64, def: 100, spa: 120, spd: 80, spe: 39},
		abilities: {0: "Magma Armor", 1: "Flame Body", H: "Weak Armor"},
		heightm: 0.8,
		weightkg: 55,
		color: "Red",
	...
	corsola: {
		...
		types: ["Water", "Rock"],
		gender: "M",
		baseStats: {hp: 60, atk: 75, def: 85, spa: 85, spd: 80, spe: 35},
	...
	octillery: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 75, atk: 104, def: 80, spa: 120, spd: 95, spe: 49},
	...
	delibird: {
		...
		types: ["Ice", "Flying"],
		gender: "M",
		baseStats: {hp: 60, atk: 66, def: 60, spa: 75, spd: 65, spe: 75},
	...
	mantine: {
		...
		types: ["Water", "Flying"],
		gender: "M",
		baseStats: {hp: 85, atk: 91, def: 70, spa: 120, spd: 125, spe: 75},
	...
	skarmory: {
		...
		types: ["Steel", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 94, def: 125, spa: 50, spd: 81, spe: 84},
	...
	houndoom: {
		...
		gender: "M",
		types: ["Dark", "Fire"],
		baseStats: {hp: 70, atk: 90, def: 65, spa: 114, spd: 80, spe: 93},
		abilities: {0: "Early Bird", 1: "Flash Fire", H: "Unnerve"},
		heightm: 1.4,
		weightkg: 35,
		color: "Black",
	...
	kingdra: {
		...
		types: ["Water", "Dragon"],
		gender: "M",
		baseStats: {hp: 70, atk: 97, def: 95, spa: 120, spd: 95, spe: 85},
		abilities: {0: "Swift Swim", 1: "Sniper", H: "Damp"},
		heightm: 1.8,
		weightkg: 152,
		color: "Blue",
	...
	donphan: {
		...
		types: ["Ground"],
		gender: "M",
		baseStats: {hp: 90, atk: 118, def: 120, spa: 61, spd: 77, spe: 57},
	...
	stantler: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 80, atk: 85, def: 67, spa: 86, spd: 72, spe: 73},
	...
	smeargle: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 70, atk: 78, def: 72, spa: 78, spd: 72, spe: 75},
	...
	hitmontop: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 100, atk: 110, def: 100, spa: 60, spd: 100, spe: 100},
	...
	miltank: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 105, atk: 74, def: 75, spa: 55, spd: 96, spe: 71},
	...
	raikou: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 100, atk: 115, def: 91, spa: 135, spd: 115, spe: 134},
	...
	entei: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 100, atk: 134, def: 108, spa: 122, spd: 102, spe: 104},
	...
	suicune: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 100, atk: 138, def: 94, spa: 150, spd: 100, spe: 108},
	...
	tyranitar: {
		...
		types: ["Rock", "Dark"],
		gender: "M",
		baseStats: {hp: 80, atk: 96, def: 110, spa: 60, spd: 100, spe: 61},
	...
	lugia: {
		...
		types: ["Water", "Flying"],
		gender: "M",
		baseStats: {hp: 120, atk: 90, def: 160, spa: 105, spd: 175, spe: 95},
		abilities: {0: "Drizzle"},
		heightm: 5.2,
		weightkg: 216,
		color: "White",
	...
	hooh: {
		...
		types: ["Fire", "Flying"],
		gender: "M",
		baseStats: {hp: 40, atk: 90, def: 40, spa: 80, spd: 5, spe: 40},
		abilities: {0: "Drought"},
		heightm: 3.8,
		weightkg: 100,
		color: "Red",
	...
	celebi: {
		...
		types: ["Psychic", "Grass"],
		gender: "M",
		baseStats: {hp: 100, atk: 93, def: 78, spa: 138, spd: 100, spe: 125},
	...
	sceptile: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 70, atk: 60, def: 65, spa: 89, spd: 78, spe: 105},
		abilities: {0: "Overgrow", H: "Unburden"},
		heightm: 1.7,
		weightkg: 52.2,
		color: "Green",
	...
	blaziken: {
		...
		types: ["Fire", "Fighting"],
		gender: "M",
		baseStats: {hp: 80, atk: 122, def: 65, spa: 115, spd: 65, spe: 102},
		abilities: {0: "Blaze", H: "Speed Boost"},
		heightm: 1.9,
		weightkg: 52,
		color: "Red",
	...
	swampert: {
		...
		types: ["Water", "Ground"],
		gender: "M",
		baseStats: {hp: 90, atk: 119, def: 82, spa: 94, spd: 79, spe: 81},
		abilities: {0: "Torrent", H: "Damp"},
		heightm: 1.5,
		weightkg: 81.9,
		color: "Blue",
	...
	mightyena: {
		...
		types: ["Dark"],
		gender: "M",
		baseStats: {hp: 70, atk: 90, def: 70, spa: 67, spd: 70, spe: 91},
	...
	linoone: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 68, atk: 90, def: 67, spa: 60, spd: 70, spe: 115},
		abilities: {0: "Pickup", 1: "Gluttony", H: "Quick Feet"},
		heightm: 0.5,
		weightkg: 32.5,
		color: "White",
	...
	beautifly: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 60, atk: 70, def: 59, spa: 73, spd: 69, spe: 64},
	...
	dustox: {
		...
		types: ["Bug", "Poison"],
		gender: "M",
		baseStats: {hp: 69, atk: 66, def: 70, spa: 72, spd: 90, spe: 65},
	...
	ludicolo: {
		...
		types: ["Water", "Grass"],
		gender: "M",
		baseStats: {hp: 99, atk: 85, def: 70, spa: 112, spd: 85, spe: 64},
		abilities: {0: "Swift Swim", 1: "Rain Dish", H: "Own Tempo"},
		heightm: 1.5,
		weightkg: 55,
		color: "Green",
	...
	shiftry: {
		...
		types: ["Grass", "Dark"],
		gender: "M",
		baseStats: {hp: 85, atk: 95, def: 63, spa: 70, spd: 60, spe: 74},
	...
	swellow: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 95, def: 60, spa: 75, spd: 60, spe: 125},
		abilities: {0: "Guts", H: "Scrappy"},
		heightm: 0.7,
		weightkg: 19.8,
		color: "Blue",
	...
	pelipper: {
		...
		types: ["Water", "Flying"],
		gender: "M",
		baseStats: {hp: 65, atk: 83, def: 101, spa: 105, spd: 87, spe: 77},
	...
	gardevoir: {
		...
		types: ["Psychic", "Fairy"],
		gender: "F",
		baseStats: {hp: 78, atk: 75, def: 55, spa: 125, spd: 125, spe: 110},
		abilities: {0: "Synchronize", 1: "Trace", H: "Telepathy"},
		heightm: 1.6,
		weightkg: 48.4,
		color: "White",
	...
	masquerain: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 68, atk: 59, def: 62, spa: 90, spd: 80, spe: 78},
	...
	breloom: {
		...
		gender: "M",
		baseStats: {hp: 70, atk: 80, def: 80, spa: 60, spd: 60, spe: 70},
	...
	slaking: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 99, atk: 115, def: 76, spa: 72, spd: 86, spe: 55},
	...
	ninjask: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 61, atk: 90, def: 55, spa: 70, spd: 65, spe: 160},
	...
	shedinja: {
		...
		types: ["Bug", "Ghost"],
		gender: "M",
		baseStats: {hp: 1, atk: 92, def: 50, spa: 90, spd: 50, spe: 70},
		maxHP: 1,
	...
	exploud: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 97, atk: 100, def: 80, spa: 91, spd: 73, spe: 68},
		abilities: {0: "Soundproof", H: "Scrappy"},
		heightm: 1.5,
		weightkg: 84,
		color: "Blue",
	...
	hariyama: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 94, atk: 125, def: 60, spa: 60, spd: 90, spe: 55},
		abilities: {0: "Thick Fat", 1: "Guts", H: "Sheer Force"},
		heightm: 2.3,
		weightkg: 253.8,
		color: "Brown",
	...
	delcatty: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 60, atk: 50, def: 65, spa: 58, spd: 60, spe: 88},
		abilities: {0: "Cute Charm", 1: "Normalize", H: "Wonder Skin"},
		heightm: 1.1,
		weightkg: 32.6,
		color: "Purple",
	...
	sableye: {
		...
		types: ["Dark", "Ghost"],
		gender: "M",
		baseStats: {hp: 60, atk: 75, def: 75, spa: 97, spd: 95, spe: 62},
	...
	mawile: {
		...
		types: ["Steel", "Fairy"],
		gender: "M",
		baseStats: {hp: 60, atk: 95, def: 88, spa: 55, spd: 65, spe: 54},
	...
	aggron: {
		...
		gender: "M",
		types: ["Steel", "Rock"],
		baseStats: {hp: 70, atk: 110, def: 138, spa: 61, spd: 88, spe: 65},
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Heavy Metal"},
		heightm: 2.1,
		weightkg: 360,
		color: "Gray",
	...
	medicham: {
		...
		types: ["Fighting", "Psychic"],
		gender: "M",
		baseStats: {hp: 59, atk: 70, def: 70, spa: 95, spd: 76, spe: 80},
		abilities: {0: "Pure Power", H: "Telepathy"},
		heightm: 1.3,
		weightkg: 31.5,
		color: "Red",
	...
	manectric: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 70, atk: 70, def: 60, spa: 90, spd: 60, spe: 105},
		abilities: {0: "Static", 1: "Lightning Rod", H: "Minus"},
		heightm: 1.5,
		weightkg: 40.2,
		color: "Yellow",
	...
	plusle: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 60, atk: 50, def: 60, spa: 85, spd: 85, spe: 95},
	...
	minun: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 60, atk: 60, def: 50, spa: 85, spd: 85, spe: 95},
	...
	volbeat: {
		...
		types: ["Bug"],
		gender: "M",
		baseStats: {hp: 65, atk: 73, def: 75, spa: 54, spd: 88, spe: 85},
	...
	swalot: {
		...
		types: ["Poison"],
		gender: "M",
		baseStats: {hp: 145, atk: 60, def: 67, spa: 40, spd: 67, spe: 40},
		abilities: {0: "Liquid Ooze", 1: "Sticky Hold", H: "Gluttony"},
		heightm: 1.7,
		weightkg: 80,
		color: "Purple",
	...
	sharpedo: {
		...
		types: ["Water", "Dark"],
		gender: "M",
		baseStats: {hp: 70, atk: 122, def: 60, spa: 117, spd: 60, spe: 105},
		abilities: {0: "Rough Skin", H: "Speed Boost"},
		heightm: 1.8,
		weightkg: 88.8,
		color: "Blue",
	...
	wailord: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 130, atk: 100, def: 80, spa: 140, spd: 80, spe: 70},
		abilities: {0: "Water Veil", 1: "Oblivious", H: "Pressure"},
		heightm: 14.5,
		weightkg: 398,
		color: "Blue",
	...
	camerupt: {
		...
		types: ["Fire", "Ground"],
		gender: "M",
		baseStats: {hp: 70, atk: 70, def: 100, spa: 75, spd: 105, spe: 40},
	...
	torkoal: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 70, atk: 85, def: 160, spa: 86, spd: 100, spe: 15},
	...
	grumpig: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 71, atk: 73, def: 75, spa: 81, spd: 72, spe: 70},
		abilities: {0: "Thick Fat", 1: "Own Tempo", H: "Gluttony"},
		heightm: 0.9,
		weightkg: 71.5,
		color: "Purple",
	...
	cacturne: {
		...
		types: ["Grass", "Dark"],
		gender: "M",
		baseStats: {hp: 99, atk: 130, def: 108, spa: 61, spd: 98, spe: 74},
		abilities: {0: "Sand Veil", H: "Water Absorb"},
		heightm: 1.3,
		weightkg: 77.4,
		color: "Green",
	...
	altaria: {
		...
		types: ["Dragon", "Flying"],
		gender: "M",
		baseStats: {hp: 90, atk: 60, def: 80, spa: 90, spd: 99, spe: 76},
		abilities: {0: "Natural Cure", H: "Cloud Nine"},
		heightm: 1.1,
		weightkg: 20.6,
		color: "Blue",
	...
	zangoose: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 73, atk: 106, def: 66, spa: 61, spd: 64, spe: 86},
	...
	seviper: {
		...
		types: ["Poison"],
		gender: "M",
		baseStats: {hp: 70, atk: 90, def: 65, spa: 90, spd: 70, spe: 84},
	...
	lunatone: {
		...
		types: ["Rock", "Psychic"],
		gender: "M",
		baseStats: {hp: 65, atk: 60, def: 95, spa: 105, spd: 100, spe: 75},
		abilities: {0: "Levitate"},
		heightm: 1,
		weightkg: 168,
		color: "Yellow",
	...
	solrock: {
		...
		types: ["Rock", "Psychic"],
		gender: "M",
		baseStats: {hp: 70, atk: 80, def: 107, spa: 108, spd: 90, spe: 79},
		abilities: {0: "Levitate"},
		heightm: 1.2,
		weightkg: 154,
		color: "Red",
	...
	whiscash: {
		...
		types: ["Water", "Ground"],
		gender: "M",
		baseStats: {hp: 80, atk: 118, def: 73, spa: 106, spd: 91, spe: 68},
		abilities: {0: "Oblivious", 1: "Anticipation", H: "Hydration"},
		heightm: 0.9,
		weightkg: 23.6,
		color: "Blue",
	...
	crawdaunt: {
		...
		types: ["Water", "Dark"],
		gender: "M",
		baseStats: {hp: 65, atk: 125, def: 115, spa: 114, spd: 69, spe: 76},
		abilities: {0: "Hyper Cutter", 1: "Shell Armor", H: "Adaptability"},
		heightm: 1.1,
		weightkg: 32.8,
		color: "Red",
	...
	claydol: {
		...
		types: ["Ground", "Psychic"],
		gender: "M",
		baseStats: {hp: 65, atk: 77, def: 105, spa: 120, spd: 115, spe: 75},
		abilities: {0: "Levitate"},
		heightm: 1.5,
		weightkg: 108,
		color: "Black",
	...
	cradily: {
		...
		types: ["Rock", "Grass"],
		gender: "M",
		baseStats: {hp: 86, atk: 81, def: 97, spa: 74, spd: 98, spe: 47},
		abilities: {0: "Suction Cups", H: "Storm Drain"},
		heightm: 1.5,
		weightkg: 60.4,
		color: "Green",
	...
	armaldo: {
		...
		types: ["Rock", "Bug"],
		gender: "M",
		baseStats: {hp: 70, atk: 116, def: 110, spa: 70, spd: 80, spe: 70},
		abilities: {0: "Battle Armor", H: "Swift Swim"},
		heightm: 1.5,
		weightkg: 68.2,
		color: "Gray",
	...
	milotic: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 95, atk: 64, def: 79, spa: 125, spd: 125, spe: 81},
	...
	castform: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 65, atk: 70, def: 75, spa: 90, spd: 77, spe: 70},
	...
	kecleon: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 70, atk: 78, def: 100, spa: 88, spd: 100, spe: 60},
	...
	banette: {
		...
		gender: "M",
		types: ["Ghost"],
		baseStats: {hp: 69, atk: 115, def: 70, spa: 86, spd: 73, spe: 73},
		abilities: {0: "Insomnia", 1: "Frisk", H: "Cursed Body"},
		heightm: 1.1,
		weightkg: 12.5,
		color: "Black",
	...
	tropius: {
		...
		gender: "M",
		types: ["Grass", "Flying"],
		baseStats: {hp: 99, atk: 69, def: 81, spa: 72, spd: 87, spe: 64},
	...
	chimecho: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 65, atk: 50, def: 80, spa: 117, spd: 95, spe: 85},
		abilities: {0: "Levitate"},
		heightm: 0.6,
		weightkg: 1,
		color: "Blue",
	...
	absol: {
		...
		types: ["Dark"],
		gender: "M",
		baseStats: {hp: 65, atk: 130, def: 70, spa: 110, spd: 95, spe: 85},
	...
	glalie: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 80, atk: 85, def: 88, spa: 81, spd: 80, spe: 80},
		abilities: {0: "Inner Focus", 1: "Ice Body", H: "Moody"},
		heightm: 1.5,
		weightkg: 256.5,
		color: "Gray",
	...
	walrein: {
		...
		types: ["Ice", "Water"],
		gender: "M",
		baseStats: {hp: 100, atk: 103, def: 85, spa: 110, spd: 90, spe: 65},
		abilities: {0: "Thick Fat", 1: "Ice Body", H: "Oblivious"},
		heightm: 1.4,
		weightkg: 150.6,
		color: "Blue",
	...
	huntail: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 63, atk: 108, def: 99, spa: 100, spd: 75, spe: 90},
	...
	gorebyss: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 70, atk: 84, def: 80, spa: 107, spd: 75, spe: 90},
	...
	relicanth: {
		...
		types: ["Water", "Rock"],
		gender: "M",
		baseStats: {hp: 95, atk: 115, def: 120, spa: 90, spd: 70, spe: 75},
	...
	luvdisc: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 60, atk: 71, def: 56, spa: 89, spd: 67, spe: 82},
		abilities: {0: "Swift Swim", H: "Hydration"},
		heightm: 0.6,
		weightkg: 8.7,
		color: "Pink",
	...
	salamence: {
		...
		types: ["Dragon", "Flying"],
		gender: "M",
		baseStats: {hp: 95, atk: 135, def: 75, spa: 110, spd: 75, spe: 90},
		abilities: {0: "Intimidate", H: "Moxie"},
		heightm: 1.5,
		weightkg: 102.6,
		color: "Blue",
	...
	metagross: {
		...
		types: ["Steel", "Psychic"],
		gender: "M",
		baseStats: {hp: 85, atk: 145, def: 104, spa: 99, spd: 95, spe: 55},
		abilities: {0: "Clear Body", H: "Light Metal"},
		heightm: 1.6,
		weightkg: 550,
		color: "Blue",
	...
	regirock: {
		...
		types: ["Rock"],
		gender: "M",
		baseStats: {hp: 100, atk: 120, def: 150, spa: 100, spd: 120, spe: 90},
	...
	regice: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 120, spa: 120, spd: 150, spe: 90},
	...
	registeel: {
		...
		types: ["Steel"],
		gender: "M",
		baseStats: {hp: 100, atk: 110, def: 135, spa: 110, spd: 135, spe: 90},
	...
	latias: {
		...
		types: ["Dragon", "Fire"],
		gender: "F",
		baseStats: {hp: 150, atk: 75, def: 100, spa: 105, spd: 105, spe: 95},
		abilities: {0: "Levitate"},
		heightm: 1.6,
		weightkg: 45,
		color: "Red",
	...
	latiasmega: {
		...
		types: ["Dragon", "Fire"],
		gender: "F",
		baseStats: {hp: 150, atk: 85, def: 120, spa: 125, spd: 130, spe: 100},
		abilities: {0: "Levitate"},
		heightm: 1.8,
		weightkg: 52,
		color: "Purple",
	...
	latios: {
		...
		types: ["Dragon", "Water"],
		gender: "M",
		baseStats: {hp: 130, atk: 125, def: 100, spa: 165, spd: 110, spe: 160},
		abilities: {0: "Levitate"},
		heightm: 2,
		weightkg: 80,
		color: "Blue",
	...
	latiosmega: {
		...
		types: ["Dragon", "Water"],
		gender: "M",
		baseStats: {hp: 130, atk: 140, def: 120, spa: 220, spd: 130, spe: 190},
		abilities: {0: "Levitate"},
		heightm: 2.3,
		weightkg: 110,
		color: "Purple",
	...
	kyogre: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 160, atk: 325, def: 250, spa: 390, spd: 135, spe: 250},
		abilities: {0: "Beast Boost", H: "Primordial Sea"},
		heightm: 7.0,
		weightkg: 2000.0,
		color: "Blue",
		tags: ["Restricted Legendary"],
	...
	kyogreprimal: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 160, atk: 410, def: 320, spa: 490, spd: 180, spe: 380},
	...
	groudon: {
		...
		types: ["Fire", "Ground"],
		gender: "M",
		baseStats: {hp: 179, atk: 166, def: 72, spa: 166, spd: 72, spe: 25},
		abilities: {0: "Drought"},
		heightm: 4.0,
		weightkg: 999.9,
		color: "Red",
	...
	groudonprimal: {
		...
		types: ["Fire", "Ground"],
		gender: "M",
		baseStats: {hp: 179, atk: 222, def: 107, spa: 222, spd: 107, spe: 25},
	...
	rayquaza: {
		...
		types: ["Dragon", "Flying"],
		gender: "M",
		baseStats: {hp: 100, atk: 140, def: 45, spa: 140, spd: 50, spe: 113},
	...
	rayquazamega: {
		...
		types: ["Dragon", "Flying"],
		gender: "M",
		baseStats: {hp: 100, atk: 180, def: 70, spa: 180, spd: 70, spe: 129},
	...
	jirachi: {
		...
		types: ["Steel", "Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 103, def: 102, spa: 150, spd: 130, spe: 116},
	...
	deoxys: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 150, def: 92, spa: 150, spd: 92, spe: 111},
		abilities: {0: "Adaptability"},
		heightm: 1.85,
		weightkg: 70.8,
		color: "Red",
	...
	deoxysattack: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 224, def: 96, spa: 221, spd: 96, spe: 151},
		abilities: {0: "Pure Power"},
		heightm: 1.85,
		weightkg: 70.8,
		color: "Red",
	...
	deoxysdefense: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 165, def: 223, spa: 101, spd: 223, spe: 76},
	...
	deoxysspeed: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 120, def: 99, spa: 120, spd: 99, spe: 350},
		abilities: {0: "Speed Boost"},
		heightm: 1.85,
		weightkg: 70.8,
		color: "Red",
	...
	torterra: {
		...
		types: ["Grass", "Ground"],
		gender: "M",
		baseStats: {hp: 100, atk: 104, def: 109, spa: 70, spd: 85, spe: 50},
		abilities: {0: "Overgrow", H: "Shell Armor"},
		heightm: 2.2,
		weightkg: 310,
		color: "Green",
	...
	infernape: {
		...
		types: ["Fire", "Fighting"],
		gender: "M",
		baseStats: {hp: 73, atk: 82, def: 71, spa: 70, spd: 71, spe: 89},
		abilities: {0: "Blaze", H: "Iron Fist"},
		heightm: 1.2,
		weightkg: 55,
		color: "Brown",
	...
	empoleon: {
		...
		types: ["Water", "Steel"],
		gender: "M",
		baseStats: {hp: 95, atk: 114, def: 80, spa: 119, spd: 95, spe: 60},
		abilities: {0: "Torrent", H: "Competitive"},
		heightm: 1.7,
		weightkg: 84.5,
		color: "Blue",
	...
	staraptor: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 85, atk: 120, def: 75, spa: 50, spd: 60, spe: 100},
		abilities: {0: "Intimidate", H: "Reckless"},
		heightm: 1.2,
		weightkg: 24.9,
		color: "Brown",
	...
	bibarel: {
		...
		types: ["Normal", "Water"],
		gender: "M",
		baseStats: {hp: 90, atk: 95, def: 60, spa: 79, spd: 60, spe: 70},
		abilities: {0: "Simple", 1: "Unaware", H: "Moody"},
		heightm: 1,
		weightkg: 31.5,
		color: "Brown",
	...
	kricketune: {
		...
		types: ["Bug"],
		gender: "M",
		baseStats: {hp: 77, atk: 70, def: 51, spa: 60, spd: 60, spe: 70},
	...
	luxray: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 80, atk: 90, def: 80, spa: 55, spd: 80, spe: 120},
		abilities: {0: "Rivalry", 1: "Intimidate", H: "Guts"},
		heightm: 1.4,
		weightkg: 42,
		color: "Blue",
	...
	roserade: {
		...
		types: ["Grass", "Poison"],
		gender: "M",
		baseStats: {hp: 65, atk: 50, def: 60, spa: 105, spd: 75, spe: 75},
	...
	rampardos: {
		...
		types: ["Rock"],
		gender: "M",
		baseStats: {hp: 100, atk: 101, def: 56, spa: 56, spd: 64, spe: 78},
		abilities: {0: "Mold Breaker", H: "Sheer Force"},
		heightm: 1.6,
		weightkg: 102.5,
		color: "Blue",
	...
	bastiodon: {
		...
		types: ["Rock", "Steel"],
		gender: "M",
		baseStats: {hp: 60, atk: 92, def: 168, spa: 47, spd: 138, spe: 40},
		abilities: {0: "Sturdy", H: "Soundproof"},
		heightm: 1.3,
		weightkg: 149.5,
		color: "Gray",
	...
	wormadam: {
		...
		types: ["Bug", "Grass"],
		gender: "M",
		baseStats: {hp: 65, atk: 40, def: 75, spa: 74, spd: 80, spe: 40},
	...
	mothim: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 65, atk: 71, def: 55, spa: 84, spd: 71, spe: 69},
	...
	vespiquen: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 76, atk: 100, def: 100, spa: 100, spd: 100, spe: 74},
	...
	floatzel: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 85, atk: 115, def: 60, spa: 105, spd: 80, spe: 115},
		abilities: {0: "Swift Swim", H: "Water Veil"},
		heightm: 1.1,
		weightkg: 33.5,
		color: "Brown",
	...
	cherrim: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 68, atk: 52, def: 69, spa: 79, spd: 78, spe: 63},
	...
	gastrodon: {
		...
		types: ["Water", "Ground"],
		gender: "M",
		baseStats: {hp: 92, atk: 90, def: 77, spa: 111, spd: 88, spe: 42},
		abilities: {0: "Sticky Hold", 1: "Storm Drain", H: "Sand Force"},
		heightm: 0.9,
		weightkg: 29.9,
		color: "Purple",
	...
	ambipom: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 75, atk: 90, def: 66, spa: 60, spd: 66, spe: 85},
	...
	drifblim: {
		...
		types: ["Ghost", "Flying"],
		gender: "M",
		baseStats: {hp: 90, atk: 77, def: 65, spa: 90, spd: 83, spe: 78},
		abilities: {0: "Aftermath", 1: "Unburden", H: "Flare Boost"},
		heightm: 1.2,
		weightkg: 15,
		color: "Purple",
	...
	lopunny: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 65, atk: 76, def: 64, spa: 54, spd: 76, spe: 81},
	...
	mismagius: {
		...
		types: ["Ghost"],
		gender: "M",
		baseStats: {hp: 85, atk: 85, def: 85, spa: 105, spd: 105, spe: 105},
		abilities: {0: "Levitate"},
		heightm: 0.9,
		weightkg: 4.4,
		color: "Purple",
	...
	honchkrow: {
		...
		types: ["Dark", "Flying"],
		gender: "M",
		baseStats: {hp: 90, atk: 125, def: 61, spa: 105, spd: 61, spe: 77},
	...
	purugly: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 98, atk: 80, def: 59, spa: 50, spd: 57, spe: 89},
	...
	skuntank: {
		...
		types: ["Poison", "Dark"],
		gender: "M",
		baseStats: {hp: 75, atk: 82, def: 70, spa: 82, spd: 75, spe: 74},
		abilities: {0: "Stench", 1: "Aftermath", H: "Keen Eye"},
		heightm: 1,
		weightkg: 38,
		color: "Purple",
	...
	bronzong: {
		...
		types: ["Steel", "Psychic"],
		gender: "M",
		baseStats: {hp: 67, atk: 89, def: 116, spa: 116, spd: 116, spe: 33},
		abilities: {0: "Levitate", 1: "Heatproof", H: "Heavy Metal"},
		heightm: 1.3,
		weightkg: 187,
		color: "Green",
	...
	chatot: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 60, atk: 74, def: 67, spa: 80, spd: 72, spe: 80},
		abilities: {0: "Keen Eye", 1: "Tangled Feet", H: "Big Pecks"},
		heightm: 0.5,
		weightkg: 1.9,
		color: "Black",
	...
	spiritomb: {
		...
		types: ["Ghost", "Dark"],
		gender: "M",
		baseStats: {hp: 50, atk: 65, def: 145, spa: 150, spd: 145, spe: 15},
	...
	garchomp: {
		...
		types: ["Dragon", "Ground"],
		gender: "M",
		baseStats: {hp: 90, atk: 100, def: 80, spa: 53, spd: 68, spe: 74},
		abilities: {0: "Sand Veil", H: "Rough Skin"},
		heightm: 1.9,
		weightkg: 95,
		color: "Blue",
	...
	lucario: {
		...
		gender: "M",
		baseStats: {hp: 50, atk: 95, def: 55, spa: 110, spd: 65, spe: 160},
	...
	lucariomega: {
		...
		types: ["Fighting", "Steel"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 50, atk: 110, def: 75, spa: 130, spd: 90, spe: 190},
		abilities: {0: "Adaptability"},
		heightm: 2.1,
		weightkg: 57.5,
		color: "Blue",
	...
	hippowdon: {
		...
		types: ["Ground"],
		gender: "M",
		baseStats: {hp: 128, atk: 120, def: 122, spa: 68, spd: 86, spe: 46},
		abilities: {0: "Sand Stream", H: "Sand Force"},
		heightm: 2,
		weightkg: 300,
		color: "Brown",
	...
	drapion: {
		...
		types: ["Poison", "Dark"],
		gender: "M",
		baseStats: {hp: 90, atk: 124, def: 110, spa: 70, spd: 65, spe: 65},
		abilities: {0: "Battle Armor", 1: "Sniper", H: "Keen Eye"},
		heightm: 1.3,
		weightkg: 61.5,
		color: "Purple",
	...
	toxicroak: {
		...
		types: ["Poison", "Fighting"],
		gender: "M",
		baseStats: {hp: 70, atk: 117, def: 68, spa: 96, spd: 73, spe: 106},
		abilities: {0: "Anticipation", 1: "Dry Skin", H: "Poison Touch"},
		heightm: 1.3,
		weightkg: 44.4,
		color: "Blue",
	...
	carnivine: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 74, atk: 86, def: 73, spa: 74, spd: 76, spe: 68},
		abilities: {0: "Levitate"},
		heightm: 1.4,
		weightkg: 27,
		color: "Green",
	...
	lumineon: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 69, atk: 69, def: 69, spa: 96, spd: 69, spe: 82},
		abilities: {0: "Swift Swim", 1: "Storm Drain", H: "Water Veil"},
		heightm: 1.2,
		weightkg: 24,
		color: "Blue",
	...
	weavile: {
		...
		types: ["Dark", "Ice"],
		gender: "M",
		baseStats: {hp: 70, atk: 120, def: 65, spa: 95, spd: 92, spe: 125},
	...
	magnezone: {
		...
		types: ["Electric", "Steel"],
		gender: "M",
		baseStats: {hp: 70, atk: 78, def: 115, spa: 131, spd: 90, spe: 70},
		abilities: {0: "Magnet Pull", 1: "Sturdy", H: "Analytic"},
		heightm: 1.2,
		weightkg: 180,
		color: "Gray",
	...
	lickilicky: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 100, atk: 95, def: 105, spa: 75, spd: 108, spe: 50},
		abilities: {0: "Own Tempo", 1: "Oblivious", H: "Cloud Nine"},
		heightm: 1.7,
		weightkg: 140,
		color: "Pink",
	...
	rhyperior: {
		...
		types: ["Ground", "Rock"],
		gender: "M",
		baseStats: {hp: 90, atk: 137, def: 128, spa: 58, spd: 77, spe: 46},
	...
	tangrowth: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 78, atk: 97, def: 125, spa: 105, spd: 50, spe: 55},
		abilities: {0: "Chlorophyll", 1: "Leaf Guard", H: "Regenerator"},
		heightm: 2,
		weightkg: 128.6,
		color: "Blue",
	...
	electivire: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 75, atk: 83, def: 67, spa: 55, spd: 85, spe: 65},
	...
	magmortar: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 120, atk: 55, def: 55, spa: 90, spd: 75, spe: 63},
		abilities: {0: "Flame Body", H: "Vital Spirit"},
		heightm: 1.6,
		weightkg: 68,
		color: "Red",
	...
	togekiss: {
		...
		types: ["Fairy", "Flying"],
		gender: "M",
		baseStats: {hp: 90, atk: 45, def: 95, spa: 110, spd: 120, spe: 86},
		abilities: {0: "Hustle", 1: "Serene Grace", H: "Super Luck"},
		heightm: 1.5,
		weightkg: 38,
		color: "White",
	...
	yanmega: {
		...
		gender: "M",
		types: ["Bug", "Flying"],
		baseStats: {hp: 86, atk: 76, def: 78, spa: 114, spd: 84, spe: 94},
	...
	leafeon: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 70, atk: 73, def: 76, spa: 49, spd: 71, spe: 62},
	...
	glaceon: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 69, atk: 59, def: 69, spa: 89, spd: 99, spe: 69},
	...
	gliscor: {
		...
		types: ["Ground", "Flying"],
		gender: "M",
		baseStats: {hp: 75, atk: 102, def: 120, spa: 75, spd: 76, spe: 94},
	...
	mamoswine: {
		...
		types: ["Ice", "Ground"],
		gender: "M",
		baseStats: {hp: 95, atk: 127, def: 90, spa: 70, spd: 73, spe: 78},
		abilities: {0: "Oblivious", 1: "Snow Cloak", H: "Thick Fat"},
		heightm: 2.5,
		weightkg: 291,
		color: "Brown",
	...
	porygonz: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 75, atk: 80, def: 85, spa: 132, spd: 87, spe: 90},
	...
	gallade: {
		...
		types: ["Psychic", "Fighting"],
		gender: "M",
		baseStats: {hp: 85, atk: 125, def: 85, spa: 95, spd: 90, spe: 125},
	...
	probopass: {
		...
		types: ["Rock", "Steel"],
		gender: "M",
		baseStats: {hp: 60, atk: 65, def: 130, spa: 95, spd: 135, spe: 50},
		abilities: {0: "Sturdy", 1: "Magnet Pull", H: "Sand Force"},
		heightm: 1.4,
		weightkg: 340,
		color: "Gray",
	...
	dusknoir: {
		...
		types: ["Ghost"],
		gender: "M",
		baseStats: {hp: 65, atk: 115, def: 120, spa: 95, spd: 120, spe: 55},
		abilities: {0: "Pressure", H: "Frisk"},
		heightm: 2.2,
		weightkg: 106.6,
		color: "Black",
	...
	froslass: {
		...
		types: ["Ice", "Ghost"],
		gender: "M",
		baseStats: {hp: 70, atk: 80, def: 69, spa: 104, spd: 91, spe: 86},
	...
	rotom: {
		...
		gender: "M",
		baseStats: {hp: 50, atk: 40, def: 60, spa: 95, spd: 70, spe: 150},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	mesprit: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 80, atk: 120, def: 120, spa: 120, spd: 120, spe: 120},
		abilities: {0: "Levitate"},
		heightm: 1.2,
		weightkg: 43.3,
		color: "Pink",
	...
	azelf: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 143, def: 92, spa: 143, spd: 92, spe: 120},
		abilities: {0: "Levitate"},
		heightm: 1.3,
		weightkg: 40.3,
		color: "Blue",
	...
	dialga: {
		...
		types: ["Steel", "Dragon"],
		gender: "M",
		baseStats: {hp: 110, atk: 150, def: 140, spa: 40, spd: 120, spe: 60},
	...
	palkia: {
		...
		types: ["Water", "Dragon"],
		gender: "M",
		baseStats: {hp: 100, atk: 90, def: 83, spa: 150, spd: 120, spe: 121},
		abilities: {0: "Drizzle"},
		heightm: 4.2,
		weightkg: 336,
		color: "Purple",
	...
	heatran: {
		...
		types: ["Fire", "Steel"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 111, spa: 145, spd: 104, spe: 95},
		abilities: {0: "Flash Fire", H: "Flame Body"},
		heightm: 1.7,
		weightkg: 430,
		color: "Brown",
	...
	regigigas: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 100, atk: 150, def: 120, spa: 90, spd: 120, spe: 80},
		abilities: {0: "Slow Start", H: "Pressure"},
		heightm: 2.8,
		weightkg: 170,
		color: "White",
		tags: ["Restricted Legendary"],
	...
	giratina: {
		...
		types: ["Ghost", "Dragon"],
		gender: "M",
		baseStats: {hp: 100, atk: 130, def: 150, spa: 86, spd: 150, spe: 80},
	...
	giratinaorigin: {
		...
		types: ["Ghost", "Dragon"],
		gender: "M",
		baseStats: {hp: 100, atk: 153, def: 90, spa: 150, spd: 90, spe: 113},
		abilities: {0: "Levitate"},
		heightm: 6.9,
		weightkg: 310,
		color: "Black",
	...
	cresselia: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 104, def: 126, spa: 112, spd: 130, spe: 97},
		abilities: {0: "Levitate"},
		heightm: 1.76,
		weightkg: 85.6,
		color: "Yellow",
	...
	manaphy: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 115, atk: 115, def: 115, spa: 145, spd: 130, spe: 130},
		abilities: {0: "Hydration"},
		heightm: 1.4,
		weightkg: 59.4,
		color: "Blue",
	...
	darkrai: {
		...
		types: ["Dark"],
		gender: "M",
		baseStats: {hp: 140, atk: 180, def: 100, spa: 225, spd: 100, spe: 490},
	...
	shaymin: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 100, atk: 90, def: 130, spa: 114, spd: 123, spe: 96},
		abilities: {0: "Natural Cure"},
		heightm: 0.6,
		weightkg: 7.1,
		color: "Green",
	...
	arceus: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 553, atk: 556, def: 556, spa: 556, spd: 556, spe: 556},
		abilities: {0: "Adaptability", 1: "Aerilate", 2: "Anger Shell", 3: "Arena Trap", 4: "Armor Tail", 5: "Aroma Veil", 6: "As One (Glastrier)", 7: "As One (Spectrier)", 8: "Aura Break", 9: "Bad Dreams", 10: "Ball Fetch", 11: "Battery", 12: "Battle Armor", 13: "Battle Bond", 14: "Beads of Ruin", 15: "Beast Boost", 16: "Berserk", 17: "Big Pecks", 18: "Blaze", 19: "Bulletproof", 20: "Cheek Pouch", 21: "Chilling Neigh", 22: "Chlorophyll", 23: "Clear Body", 24: "Cloud Nine", 25: "Color Change", 26: "Comatose", 27: "Commander", 28: "Competitive", 29: "Compound Eyes", 30: "Contrary", 31: "Corrosion", 32: "Costar", 33: "Cotton Down", 34: "Cud Chew", 35: "Curious Medicine", 36: "Cursed Body", 37: "Cute Charm", 38: "Damp", 39: "Dancer", 40: "Dark Aura", 41: "Dauntless Shield", 42: "Dazzling", 43: "Defeatist", 44: "Defiant", 45: "Delta Stream", 46: "Desolate Land", 47: "Disguise", 48: "Download", 49: "Dragon's Maw", 50: "Drizzle", 51: "Drought", 52: "Dry Skin", 53: "Early Bird", 54: "Earth Eater", 55: "Effect Spore", 56: "Electromorphosis", 57: "Emergency Exit", 58: "Fairy Aura", 59: "Filter", 60: "Flame Body", 61: "Flare Boost", 62: "Flash Fire", 63: "Flower Gift", 64: "Flower Veil", 65: "Fluffy", 66: "Forecast", 67: "Forewarn", 68: "Friend Guard", 69: "Frisk", 70: "Full Metal Body", 71: "Fur Coat", 72: "Gale Wings", 73: "Galvanize", 74: "Gluttony", 75: "Good as Gold", 76: "Gooey", 77: "Gorilla Tactics", 78: "Grass Pelt", 79: "Grim Neigh", 80: "Guard Dog", 81: "Gulp Missile", 82: "Guts", 83: "Hadron Engine", 84: "Harvest", 85: "Healer", 86: "Heatproof", 87: "Heavy Metal", 88: "Honey Gather", 89: "Huge Power", 90: "Hunger Switch", 91: "Hustle", 92: "Hydration", 93: "Hyper Cutter", 94: "Ice Body", 95: "Ice Face", 96: "Ice Scales", 97: "Illusion", 98: "Immunity", 99: "Imposter", 100: "Infiltrator", 101: "Innards Out", 102: "Inner Focus", 103: "Insomnia", 104: "Intimidate", 105: "Intrepid Sword", 106: "Iron Barbs", 107: "Iron Fist", 108: "Justified", 109: "Keen Eye", 110: "Klutz", 111: "Leaf Guard", 112: "Levitate", 113: "Libero", 114: "Light Metal", 115: "Lightning Rod", 116: "Limber", 117: "Lingering Aroma", 118: "Liquid Ooze", 119: "Liquid Voice", 120: "Long Reach", 121: "Magic Bounce", 122: "Magic Guard", 123: "Magician", 124: "Magma Armor", 125: "Magnet Pull", 126: "Marvel Scale", 127: "Mega Launcher", 128: "Merciless", 129: "Mimicry", 130: "Minus", 131: "Mirror Armor", 132: "Misty Surge", 133: "Mold Breaker", 134: "Moody", 135: "Motor Drive", 136: "Moxie", 137: "Multiscale", 138: "Multitype", 139: "Mummy", 140: "Mycelium Might", 141: "Natural Cure", 142: "Neuroforce", 143: "Neutralizing Gas", 144: "No Guard", 145: "Normalize", 146: "Oblivious", 147: "Opportunist", 148: "Orichalcum Pulse", 149: "Overcoat", 150: "Overgrow", 151: "Own Tempo", 152: "Pallid Pulse", 153: "Parental Bond", 154: "Pastel Veil", 155: "Perish Body", 156: "Pickpocket", 157: "Pickup", 158: "Pixilate", 159: "Plus", 160: "Poison Heal", 161: "Poison Point", 162: "Poison Touch", 163: "Power Construct", 164: "Power of Alchemy", 165: "Power Spot", 166: "Prankster", 167: "Pressure", 168: "Primordial Sea", 169: "Prism Armor", 170: "Propeller Tail", 171: "Protean", 172: "Protosynthesis", 173: "Psychic Surge", 174: "Punk Rock", 175: "Pure Power", 176: "Queenly Majesty", 177: "Quick Feet", 178: "Rain Dish", 179: "Rattled", 180: "Receiver", 181: "Reckless", 182: "Refrigerate", 183: "Regenerator", 184: "Ripen", 185: "Rivalry", 186: "RKS System", 187: "Rock Head", 188: "Rough Skin", 189: "Run Away", 190: "Sand Force", 191: "Sand Rush", 192: "Sand Spit", 193: "Sand Stream", 194: "Sap Sipper", 195: "Schooling", 196: "Scrappy", 197: "Screen Cleaner", 198: "Seed Sower", 199: "Serene Grace", 200: "Shadow Shield", 201: "Shadow Tag", 202: "Sharpness", 203: "Shed Skin", 204: "Sheer Force", 205: "Shell Armor", 206: "Shield Dust", 207: "Shields Down", 208: "Simple", 209: "Skill Link", 210: "Slow Start", 211: "Slush Rush", 212: "Sniper", 213: "Snow Cloak", 214: "Snow Warning", 215: "Solar Power", 216: "Solid Rock", 217: "Soul-Heart", 218: "Soundproof", 219: "Speed Boost", 220: "Stakeout", 221: "Stall", 222: "Stalwart", 223: "Stamina", 224: "Stance Change", 225: "Static", 226: "Steadfast", 227: "Steam Engine", 228: "Steelworker", 229: "Steely Spirit", 230: "Stench", 231: "Sticky Hold", 232: "Storm Drain", 233: "Strong Jaw", 234: "Sturdy", 235: "Suction Cups", 236: "Super Luck", 237: "Supreme Overlord", 238: "Surge Surfer", 239: "Swarm", 240: "Sweet Veil", 241: "Swift Swim", 242: "Symbiosis", 243: "Synchronize", 244: "Sword of Ruin", 245: "Tangled Feet", 246: "Tangling Hair", 247: "Technician", 248: "Telepathy", 249: "Teravolt", 250: "Thermal Exchange", 251: "Thick Fat", 252: "Tinted Lens", 253: "Torrent", 254: "Tough Claws", 255: "Toxic Boost", 256: "Toxic Debris", 257: "Trace", 258: "Transistor", 259: "Triage", 260: "Truant", 261: "Turboblaze", 262: "Unaware", 263: "Unburden", 264: "Unnerve", 265: "Vessel of Ruin", 266: "Victory Star", 267: "Vital Spirit", 268: "Volt Absorb", 269: "Wandering Spirit", 270: "Water Absorb", 271: "Water Bubble", 272: "Water Compaction", 273: "Water Veil", 274: "Weak Armor", 275: "Well-Baked Body", 276: "White Smoke", 277: "Wimp Out", 278: "Wonder Guard", 279: "Wonder Skin", 280: "Zen Mode", 281: "Zero to Hero"},
		heightm: 10.0,
		weightkg: 4000,
		color: "White",
		tags: ["Restricted Legendary"],
	...
	victini: {
		...
		types: ["Psychic", "Fire"],
		gender: "M",
		baseStats: {hp: 100, atk: 113, def: 93, spa: 142, spd: 121, spe: 120},
	...
	serperior: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 70, atk: 53, def: 58, spa: 95, spd: 85, spe: 82},
		abilities: {0: "Overgrow", H: "Contrary"},
		heightm: 3.3,
		weightkg: 63,
		color: "Green",
	...
	emboar: {
		...
		types: ["Fire", "Fighting"],
		gender: "M",
		baseStats: {hp: 110, atk: 100, def: 65, spa: 50, spd: 65, spe: 60},
	...
	samurott: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 75, atk: 124, def: 85, spa: 132, spd: 70, spe: 83},
		abilities: {0: "Torrent", H: "Shell Armor"},
		heightm: 1.5,
		weightkg: 94.6,
		color: "Blue",
	...
	watchog: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 70, atk: 95, def: 69, spa: 64, spd: 84, spe: 82},
	...
	stoutland: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 90, atk: 90, def: 75, spa: 55, spd: 80, spe: 70},
		abilities: {0: "Intimidate", 1: "Sand Rush", H: "Scrappy"},
		heightm: 1.2,
		weightkg: 61,
		color: "Gray",
	...
	liepard: {
		...
		types: ["Dark"],
		gender: "M",
		baseStats: {hp: 68, atk: 79, def: 60, spa: 83, spd: 70, spe: 89},
		abilities: {0: "Limber", 1: "Unburden", H: "Prankster"},
		heightm: 1.1,
		weightkg: 37.5,
		color: "Purple",
	...
	simisage: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 75, atk: 98, def: 67, spa: 98, spd: 63, spe: 99},
		abilities: {0: "Gluttony", H: "Overgrow"},
		heightm: 1.1,
		weightkg: 30.5,
		color: "Green",
	...
	simisear: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 70, atk: 83, def: 63, spa: 101, spd: 78, spe: 73},
		abilities: {0: "Gluttony", H: "Blaze"},
		heightm: 1,
		weightkg: 28,
		color: "Red",
	...
	simipour: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 75, atk: 100, def: 63, spa: 108, spd: 63, spe: 91},
		abilities: {0: "Gluttony", H: "Torrent"},
		heightm: 1,
		weightkg: 29,
		color: "Blue",
	...
	musharna: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 81, atk: 60, def: 75, spa: 107, spd: 110, spe: 65},
		abilities: {0: "Forewarn", 1: "Synchronize", H: "Telepathy"},
		heightm: 1.1,
		weightkg: 60.5,
		color: "Pink",
	...
	unfezant: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 74, atk: 87, def: 78, spa: 64, spd: 67, spe: 88},
		abilities: {0: "Big Pecks", 1: "Super Luck", H: "Rivalry"},
		heightm: 1.2,
		weightkg: 29,
		color: "Gray",
	...
	zebstrika: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 70, atk: 97, def: 63, spa: 79, spd: 67, spe: 107},
		abilities: {0: "Lightning Rod", 1: "Motor Drive", H: "Sap Sipper"},
		heightm: 1.6,
		weightkg: 79.5,
		color: "Black",
	...
	gigalith: {
		...
		types: ["Rock"],
		gender: "M",
		baseStats: {hp: 85, atk: 135, def: 135, spa: 78, spd: 89, spe: 25},
	...
	swoobat: {
		...
		types: ["Psychic", "Flying"],
		gender: "M",
		baseStats: {hp: 57, atk: 57, def: 55, spa: 97, spd: 92, spe: 99},
		abilities: {0: "Unaware", 1: "Klutz", H: "Simple"},
		heightm: 0.9,
		weightkg: 10.5,
		color: "Blue",
	...
	excadrill: {
		...
		types: ["Ground", "Steel"],
		gender: "M",
		baseStats: {hp: 75, atk: 100, def: 75, spa: 50, spd: 75, spe: 88},
		abilities: {0: "Sand Rush", 1: "Sand Force", H: "Mold Breaker"},
		heightm: 0.7,
		weightkg: 40.4,
		color: "Gray",
	...
	audino: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 155, atk: 35, def: 80, spa: 60, spd: 80, spe: 51},
	...
	conkeldurr: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 110, atk: 105, def: 75, spa: 30, spd: 77, spe: 53},
		abilities: {0: "Guts", 1: "Sheer Force", H: "Iron Fist"},
		heightm: 1.4,
		weightkg: 87,
		color: "Brown",
	...
	seismitoad: {
		...
		types: ["Water", "Ground"],
		gender: "M",
		baseStats: {hp: 83, atk: 129, def: 93, spa: 113, spd: 96, spe: 55},
	...
	throh: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 87, atk: 99, def: 85, spa: 40, spd: 84, spe: 78},
	...
	sawk: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 75, atk: 125, def: 75, spa: 45, spd: 85, spe: 91},
	...
	leavanny: {
		...
		types: ["Bug", "Grass"],
		gender: "M",
		baseStats: {hp: 70, atk: 105, def: 66, spa: 85, spd: 68, spe: 100},
		abilities: {0: "Swarm", 1: "Chlorophyll", H: "Overcoat"},
		heightm: 1.2,
		weightkg: 20.5,
		color: "Yellow",
	...
	scolipede: {
		...
		types: ["Bug", "Poison"],
		gender: "M",
		baseStats: {hp: 76, atk: 112, def: 79, spa: 66, spd: 83, spe: 82},
		abilities: {0: "Poison Point", 1: "Swarm", H: "Speed Boost"},
		heightm: 2.5,
		weightkg: 200.5,
		color: "Red",
	...
	whimsicott: {
		...
		types: ["Grass", "Fairy"],
		gender: "M",
		baseStats: {hp: 65, atk: 60, def: 80, spa: 77, spd: 75, spe: 110},
		abilities: {0: "Prankster", 1: "Infiltrator", H: "Chlorophyll"},
		heightm: 0.7,
		weightkg: 6.6,
		color: "Green",
	...
	lilligant: {
		...
		types: ["Grass"],
		gender: "F",
		baseStats: {hp: 70, atk: 50, def: 60, spa: 110, spd: 100, spe: 90},
		abilities: {0: "Chlorophyll", 1: "Own Tempo", H: "Leaf Guard"},
		heightm: 1.1,
		weightkg: 16.3,
		color: "Green",
	...
	basculin: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 70, atk: 110, def: 65, spa: 92, spd: 55, spe: 116},
	...
	krookodile: {
		...
		types: ["Ground", "Dark"],
		gender: "M",
		baseStats: {hp: 91, atk: 120, def: 84, spa: 77, spd: 74, spe: 92},
		abilities: {0: "Intimidate", 1: "Moxie", H: "Anger Point"},
		heightm: 1.5,
		weightkg: 96.3,
		color: "Red",
	...
	darmanitan: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 99, atk: 113, def: 60, spa: 40, spd: 55, spe: 101},
	...
	maractus: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 70, atk: 61, def: 73, spa: 88, spd: 74, spe: 60},
	...
	crustle: {
		...
		types: ["Bug", "Rock"],
		gender: "M",
		baseStats: {hp: 60, atk: 105, def: 122, spa: 65, spd: 85, spe: 50},
		abilities: {0: "Sturdy", 1: "Shell Armor", H: "Weak Armor"},
		heightm: 1.4,
		weightkg: 200,
		color: "Red",
	...
	scrafty: {
		...
		types: ["Dark", "Fighting"],
		gender: "M",
		baseStats: {hp: 70, atk: 105, def: 85, spa: 60, spd: 80, spe: 73},
		abilities: {0: "Shed Skin", 1: "Moxie", H: "Intimidate"},
		heightm: 1.1,
		weightkg: 30,
		color: "Red",
	...
	sigilyph: {
		...
		types: ["Psychic", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 61, def: 80, spa: 103, spd: 85, spe: 94},
	...
	cofagrigus: {
		...
		types: ["Ghost"],
		gender: "M",
		baseStats: {hp: 69, atk: 45, def: 150, spa: 126, spd: 135, spe: 45},
		abilities: {0: "Mummy"},
		heightm: 1.7,
		weightkg: 76.5,
		color: "Yellow",
	...
	carracosta: {
		...
		types: ["Water", "Rock"],
		gender: "M",
		baseStats: {hp: 74, atk: 132, def: 123, spa: 103, spd: 85, spe: 52},
		abilities: {0: "Solid Rock", 1: "Sturdy", H: "Swift Swim"},
		heightm: 1.2,
		weightkg: 81,
		color: "Blue",
	...
	archeops: {
		...
		types: ["Rock", "Flying"],
		gender: "M",
		baseStats: {hp: 80, atk: 120, def: 77, spa: 92, spd: 70, spe: 110},
		abilities: {0: "Defeatist", 1: "Rock Head"},
		heightm: 1.4,
		weightkg: 32,
		color: "Yellow",
		prevo: "Archen",
	...
	garbodor: {
		...
		types: ["Poison"],
		gender: "M",
		baseStats: {hp: 80, atk: 103, def: 82, spa: 81, spd: 87, spe: 72},
	...
	zoroark: {
		...
		types: ["Dark"],
		gender: "M",
		baseStats: {hp: 65, atk: 105, def: 60, spa: 120, spd: 60, spe: 105},
		abilities: {0: "Illusion"},
		heightm: 1.6,
		weightkg: 81.1,
		color: "Gray",
	...
	cinccino: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 70, atk: 76, def: 62, spa: 50, spd: 61, spe: 74},
		abilities: {0: "Cute Charm", 1: "Technician", H: "Skill Link"},
		heightm: 0.5,
		weightkg: 7.5,
		color: "Gray",
	...
	gothitelle: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 70, atk: 59, def: 95, spa: 114, spd: 110, spe: 65},
		abilities: {0: "Frisk", 1: "Competitive", H: "Shadow Tag"},
		heightm: 1.5,
		weightkg: 44,
		color: "Purple",
	...
	reuniclus: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 91, atk: 100, def: 88, spa: 145, spd: 95, spe: 50},
		abilities: {0: "Overcoat", 1: "Magic Guard", H: "Regenerator"},
		heightm: 1,
		weightkg: 20.1,
		color: "Green",
	...
	swanna: {
		...
		types: ["Water", "Flying"],
		gender: "M",
		baseStats: {hp: 75, atk: 97, def: 67, spa: 107, spd: 83, spe: 93},
		abilities: {0: "Keen Eye", 1: "Big Pecks", H: "Hydration"},
		heightm: 1.3,
		weightkg: 24.2,
		color: "White",
	...
	vanilluxe: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 69, atk: 85, def: 93, spa: 108, spd: 99, spe: 78},
	...
	sawsbuck: {
		...
		gender: "M",
		types: ["Normal", "Grass"],
		baseStats: {hp: 80, atk: 92, def: 70, spa: 60, spd: 70, spe: 89},
		abilities: {0: "Chlorophyll", 1: "Sap Sipper", H: "Serene Grace"},
		heightm: 1.9,
		weightkg: 92.5,
		color: "Brown",
	...
	escavalier: {
		...
		types: ["Bug", "Steel"],
		gender: "M",
		baseStats: {hp: 70, atk: 133, def: 120, spa: 60, spd: 95, spe: 40},
	...
	jellicent: {
		...
		types: ["Water", "Ghost"],
		gender: "M",
		baseStats: {hp: 90, atk: 87, def: 75, spa: 115, spd: 105, spe: 64},
		abilities: {0: "Water Absorb", 1: "Cursed Body", H: "Damp"},
		heightm: 2.2,
		weightkg: 135,
		color: "White",
	...
	alomomola: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 200, atk: 75, def: 65, spa: 89, spd: 45, spe: 70},
	...
	ferrothorn: {
		...
		types: ["Grass", "Steel"],
		gender: "M",
		baseStats: {hp: 74, atk: 119, def: 126, spa: 67, spd: 100, spe: 74},
	...
	klinklang: {
		...
		types: ["Steel"],
		gender: "M",
		baseStats: {hp: 70, atk: 110, def: 115, spa: 80, spd: 85, spe: 90},
		abilities: {0: "Plus", 1: "Minus", H: "Clear Body"},
		heightm: 0.6,
		weightkg: 81,
		color: "Gray",
	...
	eelektross: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 85, atk: 115, def: 72, spa: 113, spd: 80, spe: 100},
		abilities: {0: "Levitate"},
		heightm: 2.1,
		weightkg: 80.5,
		color: "Blue",
	...
	beheeyem: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 75, atk: 75, def: 85, spa: 133, spd: 105, spe: 45},
		abilities: {0: "Telepathy", 1: "Synchronize", H: "Analytic"},
		heightm: 1,
		weightkg: 34.5,
		color: "Brown",
	...
	chandelure: {
		...
		types: ["Ghost", "Fire"],
		gender: "M",
		baseStats: {hp: 75, atk: 90, def: 65, spa: 144, spd: 88, spe: 80},
		abilities: {0: "Flash Fire", 1: "Flame Body", H: "Infiltrator"},
		heightm: 1,
		weightkg: 34.3,
		color: "Black",
	...
	haxorus: {
		...
		types: ["Dragon"],
		gender: "M",
		baseStats: {hp: 76, atk: 147, def: 90, spa: 89, spd: 80, spe: 87},
		abilities: {0: "Rivalry", 1: "Mold Breaker", H: "Unnerve"},
		heightm: 1.8,
		weightkg: 105.5,
		color: "Yellow",
	...
	beartic: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 95, atk: 115, def: 80, spa: 60, spd: 80, spe: 65},
	...
	cryogonal: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 80, atk: 55, def: 60, spa: 95, spd: 135, spe: 105},
		abilities: {0: "Levitate"},
		heightm: 1.1,
		weightkg: 148,
		color: "Blue",
	...
	accelgor: {
		...
		types: ["Bug"],
		gender: "M",
		baseStats: {hp: 90, atk: 95, def: 40, spa: 110, spd: 75, spe: 160},
	...
	stunfisk: {
		...
		gender: "M",
		baseStats: {hp: 65, atk: 56, def: 89, spa: 93, spd: 102, spe: 17},
	...
	mienshao: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 65, atk: 110, def: 60, spa: 75, spd: 96, spe: 101},
		abilities: {0: "Inner Focus", 1: "Regenerator", H: "Reckless"},
		heightm: 1.4,
		weightkg: 35.5,
		color: "Purple",
	...
	druddigon: {
		...
		types: ["Dragon"],
		gender: "M",
		baseStats: {hp: 77, atk: 123, def: 97, spa: 80, spd: 85, spe: 76},
	...
	golurk: {
		...
		types: ["Ground", "Ghost"],
		gender: "M",
		baseStats: {hp: 89, atk: 130, def: 101, spa: 90, spd: 83, spe: 62},
		abilities: {0: "Iron Fist", 1: "Klutz", H: "No Guard"},
		heightm: 2.8,
		weightkg: 330,
		color: "Green",
	...
	bisharp: {
		...
		types: ["Dark", "Steel"],
		gender: "M",
		baseStats: {hp: 70, atk: 128, def: 115, spa: 81, spd: 85, spe: 89},
		abilities: {0: "Defiant", 1: "Inner Focus", H: "Pressure"},
		heightm: 1.6,
		weightkg: 70,
		color: "Red",
	...
	bouffalant: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 100, atk: 99, def: 95, spa: 40, spd: 75, spe: 80},
	...
	braviary: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 88, atk: 115, def: 75, spa: 62, spd: 77, spe: 83},
	...
	mandibuzz: {
		...
		types: ["Dark", "Flying"],
		gender: "M",
		baseStats: {hp: 199, atk: 40, def: 41, spa: 42, spd: 43, spe: 70},
		abilities: {0: "Big Pecks", 1: "Overcoat", H: "Weak Armor"},
		heightm: 1.2,
		weightkg: 39.5,
		color: "Brown",
	...
	heatmor: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 88, atk: 90, def: 75, spa: 96, spd: 76, spe: 70},
	...
	durant: {
		...
		types: ["Bug", "Steel"],
		gender: "M",
		baseStats: {hp: 68, atk: 112, def: 109, spa: 48, spd: 58, spe: 109},
	...
	hydreigon: {
		...
		types: ["Dark", "Dragon"],
		gender: "M",
		baseStats: {hp: 82, atk: 115, def: 80, spa: 125, spd: 80, spe: 82},
		abilities: {0: "Levitate"},
		heightm: 1.8,
		weightkg: 160,
		color: "Blue",
	...
	volcarona: {
		...
		types: ["Bug", "Fire"],
		gender: "M",
		baseStats: {hp: 95, atk: 60, def: 65, spa: 132, spd: 100, spe: 100},
		abilities: {0: "Flame Body", H: "Swarm"},
		heightm: 1.6,
		weightkg: 46,
		color: "White",
	...
	cobalion: {
		...
		gender: "M",
		baseStats: {hp: 110, atk: 120, def: 120, spa: 110, spd: 110, spe: 110},
		abilities: {0: "Full Metal Body"},
		heightm: 2.1,
		weightkg: 173,
		color: "Blue",
	...
	terrakion: {
		...
		types: ["Rock", "Fighting"],
		gender: "M",
		baseStats: {hp: 100, atk: 105, def: 135, spa: 85, spd: 119, spe: 102},
		abilities: {0: "Rock Head"},
		heightm: 1.9,
		weightkg: 140,
		color: "Gray",
	...
	virizion: {
		...
		types: ["Grass", "Fighting"],
		gender: "M",
		baseStats: {hp: 100, atk: 94, def: 116, spa: 114, spd: 120, spe: 115},
		abilities: {0: "Chlorophyll"},
		heightm: 2,
		weightkg: 90,
		color: "Green",
	...
	tornadus: {
		...
		types: ["Flying"],
		gender: "M",
		baseStats: {hp: 100, atk: 150, def: 110, spa: 143, spd: 107, spe: 106},
		abilities: {0: "Mold Breaker"},
		heightm: 1.86,
		weightkg: 104,
		color: "Green",
	...
	thundurus: {
		...
		types: ["Electric", "Flying"],
		gender: "M",
		baseStats: {hp: 100, atk: 125, def: 105, spa: 146, spd: 108, spe: 107},
		abilities: {0: "Lightning Rod"},
		heightm: 1.86,
		weightkg: 97,
		color: "Blue",
	...
	reshiram: {
		...
		types: ["Dragon", "Fire"],
		gender: "M",
		baseStats: {hp: 112, atk: 77, def: 71, spa: 118, spd: 101, spe: 101},
	...
	zekrom: {
		...
		gender: "M",
		baseStats: {hp: 100, atk: 150, def: 120, spa: 90, spd: 100, spe: 80},
	...
	landorus: {
		...
		types: ["Ground", "Flying"],
		gender: "M",
		baseStats: {hp: 100, atk: 150, def: 120, spa: 120, spd: 105, spe: 101},
		abilities: {0: "Sheer Force"},
		heightm: 1.86,
		weightkg: 107,
		color: "Brown",
	...
	kyurem: {
		...
		types: ["Dragon", "Ice"],
		gender: "M",
		baseStats: {hp: 100, atk: 135, def: 95, spa: 135, spd: 95, spe: 97},
		abilities: {0: "Snow Warning"},
		heightm: 3,
		weightkg: 325,
		color: "Gray",
	...
	kyuremblack: {
		...
		gender: "M",
		baseStats: {hp: 100, atk: 189, def: 150, spa: 135, spd: 120, spe: 90},
		abilities: {0: "Volt Absorb", 1: "Snow Warning", H: "Sheer Force"},
		heightm: 3.5,
		weightkg: 365,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	kyuremwhite: {
		...
		gender: "M",
		baseStats: {hp: 100, atk: 135, def: 120, spa: 189, spd: 150, spe: 90},
		abilities: {0: "Blaze", 1: "Snow Warning", H: "Flash Fire"},
		heightm: 3.6,
		weightkg: 325,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	keldeo: {
		...
		types: ["Water", "Fighting"],
		gender: "M",
		baseStats: {hp: 100, atk: 139, def: 97, spa: 144, spd: 97, spe: 107},
		abilities: {0: "Inner Focus"},
		heightm: 1.7,
		weightkg: 68.5,
		color: "Yellow",
	...
	meloetta: {
		...
		types: ["Normal", "Psychic"],
		gender: "F",
		baseStats: {hp: 100, atk: 110, def: 90, spa: 140, spd: 140, spe: 119},
		abilities: {0: "Serene Grace"},
		heightm: 1.6,
		weightkg: 42.5,
		color: "White",
	...
	meloettapirouette: {
		...
		types: ["Normal", "Fighting"],
		gender: "F",
		baseStats: {hp: 100, atk: 145, def: 100, spa: 145, spd: 160, spe: 149},
		abilities: {0: "Serene Grace"},
		heightm: 1.6,
		weightkg: 42.5,
		color: "White",
	...
	genesect: {
		...
		types: ["Bug", "Steel"],
		gender: "M",
		baseStats: {hp: 100, atk: 149, def: 105, spa: 149, spd: 102, spe: 135},
	...
	chesnaught: {
		...
		types: ["Grass", "Fighting"],
		gender: "M",
		baseStats: {hp: 88, atk: 83, def: 122, spa: 40, spd: 60, spe: 64},
		abilities: {0: "Overgrow", H: "Bulletproof"},
		heightm: 1.6,
		weightkg: 90,
		color: "Green",
	...
	delphox: {
		...
		types: ["Fire", "Psychic"],
		gender: "M",
		baseStats: {hp: 70, atk: 50, def: 72, spa: 104, spd: 114, spe: 100},
		abilities: {0: "Blaze", H: "Magician"},
		heightm: 1.5,
		weightkg: 39,
		color: "Red",
	...
	greninjaash: {
		...
		types: ["Water", "Dark"],
		gender: "M",
		baseStats: {hp: 140, atk: 250, def: 230, spa: 230, spd: 230, spe: 0},
		abilities: {0: "Sheer Force"},
		heightm: 2.2,
		weightkg: 879,
		color: "Blue",
	...
	diggersby: {
		...
		types: ["Normal", "Ground"],
		gender: "M",
		baseStats: {hp: 90, atk: 90, def: 79, spa: 53, spd: 75, spe: 68},
		abilities: {0: "Pickup", 1: "Cheek Pouch", H: "Huge Power"},
		heightm: 1,
		weightkg: 42.4,
		color: "Brown",
	...
	talonflame: {
		...
		gender: "M",
		types: ["Fire", "Flying"],
		baseStats: {hp: 78, atk: 91, def: 71, spa: 84, spd: 69, spe: 116},
		abilities: {0: "Flame Body", H: "Gale Wings"},
		heightm: 1.2,
		weightkg: 24.5,
		color: "Red",
	...
	vivillon: {
		...
		types: ["Bug", "Flying"],
		gender: "F",
		baseStats: {hp: 80, atk: 52, def: 50, spa: 100, spd: 95, spe: 99},
		abilities: {0: "Shield Dust", 1: "Compound Eyes", H: "Friend Guard"},
		heightm: 1.2,
		weightkg: 17,
		color: "White",
	...
	pyroar: {
		...
		types: ["Fire", "Normal"],
		gender: "M",
		baseStats: {hp: 70, atk: 65, def: 67, spa: 89, spd: 69, spe: 84},
		abilities: {0: "Rivalry", 1: "Unnerve", H: "Moxie"},
		heightm: 1.5,
		weightkg: 81.5,
		color: "Brown",
	...
	floette: {
		...
		types: ["Fairy"],
		gender: "F",
		baseStats: {hp: 90, atk: 85, def: 89, spa: 132, spd: 140, spe: 118},
		abilities: {0: "Flower Veil", H: "Symbiosis"},
		heightm: 0.2,
		weightkg: 0.9,
		color: "White",
	...
	floetteeternal: {
		...
		types: ["Fairy"],
		gender: "F",
		baseStats: {hp: 90, atk: 105, def: 115, spa: 170, spd: 160, spe: 130},
	...
	florges: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 78, atk: 49, def: 70, spa: 100, spd: 110, spe: 65},
		abilities: {0: "Flower Veil", H: "Symbiosis"},
		heightm: 1.1,
		weightkg: 10,
		color: "White",
	...
	gogoat: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 120, atk: 96, def: 66, spa: 67, spd: 79, spe: 74},
		abilities: {0: "Sap Sipper", H: "Grass Pelt"},
		heightm: 1.7,
		weightkg: 91,
		color: "Brown",
	...
	pangoro: {
		...
		types: ["Fighting", "Dark"],
		gender: "M",
		baseStats: {hp: 105, atk: 90, def: 78, spa: 50, spd: 71, spe: 63},
		abilities: {0: "Iron Fist", 1: "Mold Breaker", H: "Scrappy"},
		heightm: 2.1,
		weightkg: 136,
		color: "White",
	...
	furfrou: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 75, atk: 80, def: 65, spa: 52, spd: 88, spe: 81},
	...
	meowstic: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 74, atk: 48, def: 76, spa: 83, spd: 81, spe: 94},
	...
	aegislash: {
		...
		gender: "M",
		types: ["Steel", "Ghost"],
		baseStats: {hp: 70, atk: 100, def: 112, spa: 100, spd: 112, spe: 75},
	...
	aromatisse: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 70, atk: 51, def: 73, spa: 71, spd: 79, spe: 59},
		abilities: {0: "Healer", H: "Aroma Veil"},
		heightm: 0.8,
		weightkg: 15.5,
		color: "Pink",
	...
	slurpuff: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 132, atk: 64, def: 68, spa: 85, spd: 71, spe: 72},
		abilities: {0: "Sweet Veil", H: "Unburden"},
		heightm: 0.8,
		weightkg: 5,
		color: "White",
	...
	malamar: {
		...
		types: ["Dark", "Psychic"],
		gender: "M",
		baseStats: {hp: 88, atk: 112, def: 88, spa: 106, spd: 92, spe: 50},
		abilities: {0: "Contrary", 1: "Suction Cups", H: "Infiltrator"},
		heightm: 1.5,
		weightkg: 47,
		color: "Blue",
	...
	barbaracle: {
		...
		types: ["Rock", "Water"],
		gender: "M",
		baseStats: {hp: 72, atk: 130, def: 109, spa: 94, spd: 86, spe: 78},
		abilities: {0: "Tough Claws", 1: "Sniper", H: "Pickpocket"},
		heightm: 1.3,
		weightkg: 96,
		color: "Brown",
	...
	dragalge: {
		...
		types: ["Poison", "Dragon"],
		gender: "M",
		baseStats: {hp: 70, atk: 89, def: 59, spa: 123, spd: 80, spe: 99},
		abilities: {0: "Poison Point", 1: "Poison Touch", H: "Adaptability"},
		heightm: 1.8,
		weightkg: 81.5,
		color: "Brown",
	...
	clawitzer: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 71, atk: 123, def: 68, spa: 135, spd: 84, spe: 88},
		abilities: {0: "Mega Launcher"},
		heightm: 1.3,
		weightkg: 35.3,
		color: "Blue",
	...
	heliolisk: {
		...
		types: ["Electric", "Normal"],
		gender: "M",
		baseStats: {hp: 60, atk: 60, def: 55, spa: 103, spd: 80, spe: 109},
		abilities: {0: "Dry Skin", 1: "Sand Veil", H: "Solar Power"},
		heightm: 1,
		weightkg: 21,
		color: "Yellow",
	...
	tyrantrum: {
		...
		types: ["Rock", "Dragon"],
		gender: "M",
		baseStats: {hp: 76, atk: 121, def: 105, spa: 72, spd: 63, spe: 74},
	...
	aurorus: {
		...
		types: ["Rock", "Ice"],
		gender: "M",
		baseStats: {hp: 93, atk: 87, def: 82, spa: 109, spd: 92, spe: 68},
		abilities: {0: "Refrigerate", H: "Snow Warning"},
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
	...
	sylveon: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 95, atk: 45, def: 80, spa: 89, spd: 120, spe: 79},
	...
	hawlucha: {
		...
		types: ["Fighting", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 112, def: 75, spa: 84, spd: 73, spe: 103},
	...
	carbink: {
		...
		types: ["Rock", "Fairy"],
		gender: "M",
		baseStats: {hp: 70, atk: 60, def: 110, spa: 91, spd: 120, spe: 52},
	...
	goodra: {
		...
		types: ["Dragon"],
		gender: "M",
		baseStats: {hp: 130, atk: 40, def: 100, spa: 60, spd: 120, spe: 50},
		abilities: {0: "Sap Sipper", 1: "Hydration", H: "Gooey"},
		heightm: 2,
		weightkg: 150.5,
		color: "Purple",
	...
	klefki: {
		...
		types: ["Steel", "Fairy"],
		gender: "M",
		baseStats: {hp: 67, atk: 62, def: 84, spa: 83, spd: 87, spe: 74},
	...
	trevenant: {
		...
		gender: "M",
		types: ["Ghost", "Grass"],
		baseStats: {hp: 85, atk: 84, def: 76, spa: 65, spd: 82, spe: 56},
		abilities: {0: "Natural Cure", 1: "Frisk", H: "Harvest"},
		heightm: 1.5,
		weightkg: 71,
		color: "Brown",
	...
	gourgeist: {
		...
		types: ["Ghost", "Grass"],
		gender: "M",
		baseStats: {hp: 65, atk: 58, def: 90, spa: 75, spd: 97, spe: 52},
		abilities: {0: "Pickup", 1: "Frisk", H: "Insomnia"},
		heightm: 0.9,
		weightkg: 12.5,
		color: "Brown",
	...
	avalugg: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 95, atk: 117, def: 184, spa: 44, spd: 90, spe: 30},
		abilities: {0: "Own Tempo", 1: "Ice Body", H: "Sturdy"},
		heightm: 2,
		weightkg: 505,
		color: "Blue",
	...
	noivern: {
		...
		types: ["Flying", "Dragon"],
		gender: "M",
		baseStats: {hp: 85, atk: 80, def: 70, spa: 97, spd: 80, spe: 123},
		abilities: {0: "Frisk", 1: "Infiltrator", H: "Telepathy"},
		heightm: 1.5,
		weightkg: 85,
		color: "Purple",
	...
	xerneas: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 255, atk: 0, def: 185, spa: 131, spd: 210, spe: 210},
	...
	yveltal: {
		...
		tags: ["Restricted Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Yveltal-Primal"],
		formeOrder: ["Yveltal", "Yveltal-Primal"],
	},
	yveltalprimal: {
		num: 717,
		name: "Yveltal-Primal",
		...
		gender: "M",
		baseStats: {hp: 250, atk: 500, def: 410, spa: 190, spd: 410, spe: 180},
		abilities: {0: "Beast Boost"},
		heightm: 9.8,
		weightkg: 4000.0,
		color: "Black",
	...
	zygarde: {
		...
		types: ["Dragon", "Ground"],
		gender: "M",
		baseStats: {hp: 100, atk: 125, def: 121, spa: 108, spd: 115, spe: 105},
	...
	zygardecomplete: {
		...
		types: ["Dragon", "Ground"],
		gender: "M",
		baseStats: {hp: 100, atk: 218, def: 165, spa: 195, spd: 165, spe: 130},
		abilities: {0: "Huge Power"},
		heightm: 4.5,
		weightkg: 610,
		color: "Black",
	...
	diancie: {
		...
		types: ["Rock", "Fairy"],
		gender: "M",
		baseStats: {hp: 100, atk: 109, def: 117, spa: 131, spd: 131, spe: 93},
	...
	dianciemega: {
		...
		types: ["Rock", "Fairy"],
		gender: "M",
		baseStats: {hp: 100, atk: 137, def: 124, spa: 160, spd: 150, spe: 110},
		abilities: {0: "Magic Bounce"},
		heightm: 2.45,
		weightkg: 129.9,
		color: "Pink",
	...
	hoopa: {
		...
		types: ["Psychic", "Ghost"],
		gender: "M",
		baseStats: {hp: 100, atk: 115, def: 93, spa: 140, spd: 117, spe: 98},
	...
	hoopaunbound: {
		...
		types: ["Psychic", "Dark"],
		gender: "M",
		baseStats: {hp: 100, atk: 165, def: 130, spa: 165, spd: 130, spe: 98},
	...
	volcanion: {
		...
		types: ["Fire", "Water"],
		gender: "M",
		baseStats: {hp: 100, atk: 142, def: 130, spa: 150, spd: 120, spe: 75},
	...
	decidueye: {
		...
		types: ["Grass", "Ghost"],
		gender: "M",
		baseStats: {hp: 78, atk: 87, def: 80, spa: 90, spd: 100, spe: 80},
		abilities: {0: "Overgrow", H: "Long Reach"},
		heightm: 1.6,
		weightkg: 36.6,
		color: "Brown",
	...
	incineroar: {
		...
		types: ["Fire", "Dark"],
		gender: "M",
		baseStats: {hp: 70, atk: 120, def: 90, spa: 110, spd: 90, spe: 90},
		abilities: {0: "Blaze", H: "Intimidate"},
		heightm: 1.8,
		weightkg: 83,
		color: "Red",
	...
	primarina: {
		...
		types: ["Water", "Fairy"],
		gender: "M",
		baseStats: {hp: 80, atk: 60, def: 74, spa: 116, spd: 126, spe: 60},
		abilities: {0: "Torrent", H: "Liquid Voice"},
		heightm: 1.8,
		weightkg: 44,
		color: "Blue",
	...
	toucannon: {
		...
		gender: "M",
		types: ["Normal", "Flying"],
		baseStats: {hp: 80, atk: 116, def: 75, spa: 90, spd: 75, spe: 68},
	...
	gumshoos: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 88, atk: 115, def: 74, spa: 72, spd: 60, spe: 68},
		abilities: {0: "Stakeout", 1: "Strong Jaw", H: "Adaptability"},
		heightm: 0.7,
		weightkg: 14.2,
		color: "Brown",
	...
	vikavolt: {
		...
		gender: "M",
		types: ["Bug", "Electric"],
		baseStats: {hp: 77, atk: 95, def: 90, spa: 139, spd: 75, spe: 93},
		abilities: {0: "Levitate"},
		heightm: 1.5,
		weightkg: 45,
		color: "Blue",
	...
	crabominable: {
		...
		types: ["Fighting", "Ice"],
		gender: "M",
		baseStats: {hp: 80, atk: 130, def: 88, spa: 84, spd: 84, spe: 63},
		abilities: {0: "Hyper Cutter", 1: "Iron Fist", H: "Anger Point"},
		heightm: 1.7,
		weightkg: 180,
		color: "White",
	...
	lycanroc: {
		...
		types: ["Rock"],
		gender: "M",
		baseStats: {hp: 75, atk: 117, def: 65, spa: 55, spd: 65, spe: 93},
	...
	wishiwashischool: {
		...
		forme: "School",
		types: ["Water"],
		baseStats: {hp: 80, atk: 150, def: 130, spa: 150, spd: 135, spe: 55},
		abilities: {0: "Intimidate"},
		heightm: 8.2,
		weightkg: 78.6,
		color: "Blue",
	...
	toxapex: {
		...
		types: ["Poison", "Water"],
		gender: "M",
		baseStats: {hp: 70, atk: 121, def: 129, spa: 101, spd: 83, spe: 65},
		abilities: {0: "Merciless", 1: "Limber", H: "Regenerator"},
		heightm: 0.7,
		weightkg: 14.5,
		color: "Blue",
	...
	mudsdale: {
		...
		types: ["Ground"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 35, spd: 85, spe: 70},
		abilities: {0: "Own Tempo", 1: "Stamina", H: "Inner Focus"},
		heightm: 2.5,
		weightkg: 920,
		color: "Brown",
	...
	araquanid: {
		...
		types: ["Water", "Bug"],
		gender: "M",
		baseStats: {hp: 68, atk: 110, def: 92, spa: 122, spd: 117, spe: 60},
		abilities: {0: "Water Bubble", H: "Water Absorb"},
		heightm: 1.8,
		weightkg: 82,
		color: "Green",
	...
	lurantis: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 70, atk: 120, def: 90, spa: 85, spd: 90, spe: 88},
		abilities: {0: "Leaf Guard", H: "Contrary"},
		heightm: 0.9,
		weightkg: 18.5,
		color: "Pink",
	...
	shiinotic: {
		...
		types: ["Grass", "Fairy"],
		gender: "M",
		baseStats: {hp: 60, atk: 45, def: 75, spa: 76, spd: 98, spe: 50},
		abilities: {0: "Illuminate", 1: "Effect Spore", H: "Rain Dish"},
		heightm: 1,
		weightkg: 11.5,
		color: "Purple",
	...
	salazzle: {
		...
		types: ["Poison", "Fire"],
		gender: "M",
		baseStats: {hp: 68, atk: 64, def: 60, spa: 111, spd: 70, spe: 107},
		abilities: {0: "Corrosion", H: "Oblivious"},
		heightm: 1.2,
		weightkg: 22.2,
		color: "Black",
	...
	bewear: {
		...
		gender: "M",
		types: ["Normal", "Fighting"],
		baseStats: {hp: 140, atk: 120, def: 55, spa: 55, spd: 65, spe: 65},
	...
	tsareena: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 70, atk: 115, def: 75, spa: 86, spd: 90, spe: 108},
	...
	comfey: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 51, atk: 52, def: 90, spa: 82, spd: 110, spe: 85},
	...
	passimian: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 70, atk: 95, def: 68, spa: 51, spd: 70, spe: 81},
	...
	golisopod: {
		...
		types: ["Bug", "Water"],
		gender: "M",
		baseStats: {hp: 75, atk: 145, def: 128, spa: 99, spd: 92, spe: 61},
		abilities: {0: "Tough Claws"},
		heightm: 2,
		weightkg: 108,
		color: "Gray",
	...
	palossand: {
		...
		types: ["Ghost", "Ground"],
		gender: "M",
		baseStats: {hp: 85, atk: 95, def: 110, spa: 110, spd: 85, spe: 50},
		abilities: {0: "Water Compaction", H: "Sand Veil"},
		heightm: 1.3,
		weightkg: 250,
		color: "Brown",
	...
	pyukumuku: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 80, atk: 125, def: 124, spa: 90, spd: 124, spe: 10},
	...
	minior: {
		...
		types: ["Rock", "Flying"],
		gender: "M",
		baseStats: {hp: 60, atk: 90, def: 60, spa: 105, spd: 70, spe: 110},
	...
	miniormeteor: {
		...
		types: ["Rock", "Flying"],
		gender: "M",
		baseStats: {hp: 60, atk: 80, def: 90, spa: 60, spd: 95, spe: 80},
		abilities: {0: "Shields Down"},
		heightm: 0.3,
		weightkg: 40,
		color: "Brown",
	...
	komala: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 65, atk: 100, def: 65, spa: 75, spd: 95, spe: 65},
	...
	turtonator: {
		...
		types: ["Fire", "Dragon"],
		gender: "M",
		baseStats: {hp: 65, atk: 83, def: 130, spa: 103, spd: 83, spe: 41},
		abilities: {0: "Shell Armor"},
		heightm: 2,
		weightkg: 212,
		color: "Red",
	...
	togedemaru: {
		...
		types: ["Electric", "Steel"],
		gender: "M",
		baseStats: {hp: 65, atk: 83, def: 63, spa: 40, spd: 73, spe: 96},
	...
	mimikyu: {
		...
		types: ["Ghost", "Fairy"],
		gender: "M",
		baseStats: {hp: 65, atk: 103, def: 70, spa: 100, spd: 90, spe: 82},
	...
	bruxish: {
		...
		types: ["Water", "Psychic"],
		gender: "M",
		baseStats: {hp: 70, atk: 105, def: 68, spa: 98, spd: 73, spe: 94},
	...
	drampa: {
		...
		types: ["Normal", "Dragon"],
		gender: "M",
		baseStats: {hp: 140, atk: 81, def: 67, spa: 100, spd: 70, spe: 55},
	...
	dhelmise: {
		...
		types: ["Ghost", "Grass"],
		gender: "M",
		baseStats: {hp: 70, atk: 91, def: 95, spa: 45, spd: 70, spe: 60},
	...
	kommoo: {
		...
		types: ["Dragon", "Fighting"],
		gender: "M",
		baseStats: {hp: 75, atk: 95, def: 110, spa: 85, spd: 90, spe: 70},
		abilities: {0: "Bulletproof", 1: "Soundproof", H: "Overcoat"},
		heightm: 1.6,
		weightkg: 78.2,
		color: "Gray",
	...
	tapukoko: {
		...
		types: ["Electric", "Fairy"],
		gender: "M",
		baseStats: {hp: 151, atk: 140, def: 110, spa: 120, spd: 114, spe: 90},
	...
	tapulele: {
		...
		types: ["Psychic", "Fairy"],
		gender: "M",
		baseStats: {hp: 100, atk: 117, def: 89, spa: 150, spd: 120, spe: 115},
		abilities: {0: "Psychic Surge"},
		heightm: 1.8,
		weightkg: 58.6,
		color: "Pink",
	...
	tapubulu: {
		...
		types: ["Grass", "Fairy"],
		gender: "M",
		baseStats: {hp: 105, atk: 80, def: 110, spa: 70, spd: 110, spe: 95},
	...
	solgaleo: {
		...
		types: ["Fire", "Steel"],
		gender: "M",
		baseStats: {hp: 90, atk: 120, def: 92, spa: 110, spd: 82, spe: 76},
		abilities: {0: "Drought"},
		heightm: 3.4,
		weightkg: 230,
		color: "White",
	...
	lunala: {
		...
		types: ["Fairy", "Ghost"],
		gender: "M",
		baseStats: {hp: 120, atk: 120, def: 119, spa: 130, spd: 130, spe: 130},
	...
	nihilego: {
		...
		types: ["Rock", "Poison"],
		gender: "M",
		baseStats: {hp: 120, atk: 110, def: 95, spa: 130, spd: 125, spe: 115},
	...
	buzzwole: {
		...
		types: ["Bug", "Fighting"],
		gender: "M",
		baseStats: {hp: 150, atk: 200, def: 175, spa: 135, spd: 160, spe: 160},
	...
	pheromosa: {
		...
		types: ["Bug", "Fighting"],
		gender: "M",
		baseStats: {hp: 120, atk: 220, def: 100, spa: 220, spd: 100, spe: 220},
	...
	xurkitree: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 155, atk: 125, def: 170, spa: 250, spd: 170, spe: 185},
		abilities: {0: "Beast Boost", 1: "Volt Absorb", H: "Lightning Rod"},
		heightm: 3.8,
		weightkg: 100,
		color: "Black",
		tags: ["Ultra Beast"],
	...
	celesteela: {
		...
		types: ["Steel", "Flying"],
		gender: "M",
		baseStats: {hp: 140, atk: 155, def: 160, spa: 230, spd: 155, spe: 140},
	...
	kartana: {
		...
		types: ["Grass", "Steel"],
		gender: "M",
		baseStats: {hp: 900, atk: 10, def: 0, spa: 10, spd: 0, spe: 60},
		abilities: {0: "Beast Boost", 1: "Regenerator", H: "Natural Cure"},
		heightm: 1.0,
		weightkg: 7.1,
		color: "White",
		tags: ["Ultra Beast"],
	...
	guzzlord: {
		...
		types: ["Dark", "Dragon"],
		gender: "M",
		baseStats: {hp: 160, atk: 200, def: 165, spa: 190, spd: 165, spe: 100},
		abilities: {0: "Beast Boost", H: "Strong Jaw"},
		heightm: 5.5,
		weightkg: 888,
		color: "Black",
		tags: ["Ultra Beast"],
	...
	necrozma: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 150, def: 121, spa: 160, spd: 106, spe: 103},
	...
	necrozmaultra: {
		...
		gender: "M",
		baseStats: {hp: 100, atk: 185, def: 121, spa: 185, spd: 125, spe: 129},
	...
	magearna: {
		...
		types: ["Steel", "Fairy"],
		gender: "M",
		baseStats: {hp: 100, atk: 103, def: 129, spa: 141, spd: 125, spe: 94},
	...
	marshadow: {
		...
		gender: "M",
		baseStats: {hp: 100, atk: 147, def: 99, spa: 130, spd: 108, spe: 130},
		abilities: {0: "Technician"},
		heightm: 1.9,
		weightkg: 72.2,
		color: "Gray",
	...
	stakataka: {
		...
		types: ["Rock", "Steel"],
		gender: "M",
		baseStats: {hp: 150, atk: 160, def: 360, spa: 70, spd: 150, spe: 90},
	...
	blacephalon: {
		...
		types: ["Fire", "Ghost"],
		gender: "M",
		baseStats: {hp: 120, atk: 180, def: 130, spa: 220, spd: 155, spe: 175},
	...
	zeraora: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 100, atk: 130, def: 95, spa: 125, spd: 95, spe: 160},
		abilities: {0: "Volt Absorb", H: "Quick Feet"},
		heightm: 1.97,
		weightkg: 84.5,
		color: "Yellow",
	...
	melmetal: {
		...
		types: ["Steel"],
		gender: "M",
		baseStats: {hp: 100, atk: 138, def: 135, spa: 100, spd: 105, spe: 77},
	...
	rillaboom: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 90, atk: 80, def: 60, spa: 45, spd: 60, spe: 75},
		abilities: {0: "Overgrow", H: "Grassy Surge"},
		heightm: 2.1,
		weightkg: 90,
		color: "Green",
	...
	cinderace: {
		...
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 65, atk: 95, def: 65, spa: 57, spd: 65, spe: 119},
		abilities: {0: "Blaze", H: "Libero"},
		heightm: 1.4,
		weightkg: 33,
		color: "White",
	...
	inteleon: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 70, atk: 104, def: 65, spa: 130, spd: 76, spe: 118},
		abilities: {0: "Torrent", H: "Sniper"},
		heightm: 1.9,
		weightkg: 45.2,
		color: "Blue",
	...
	greedent: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 120, atk: 90, def: 90, spa: 50, spd: 75, spe: 25},
		abilities: {0: "Cheek Pouch", H: "Gluttony"},
		heightm: 0.6,
		weightkg: 6,
		color: "Brown",
	...
	corviknight: {
		...
		types: ["Flying", "Steel"],
		gender: "M",
		baseStats: {hp: 87, atk: 115, def: 105, spa: 58, spd: 85, spe: 77},
	...
	orbeetle: {
		...
		gender: "M",
		types: ["Bug", "Psychic"],
		baseStats: {hp: 70, atk: 65, def: 80, spa: 135, spd: 120, spe: 89},
	...
	eldegoss: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 50, atk: 45, def: 100, spa: 70, spd: 130, spe: 60},
		abilities: {0: "Cotton Down", 1: "Regenerator", H: "Effect Spore"},
		heightm: 0.5,
		weightkg: 2.5,
		color: "Green",
	...
	dubwool: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 70, atk: 83, def: 80, spa: 54, spd: 90, spe: 68},
	...
	drednaw: {
		...
		types: ["Water", "Rock"],
		gender: "M",
		baseStats: {hp: 90, atk: 115, def: 90, spa: 88, spd: 68, spe: 74},
		abilities: {0: "Strong Jaw", 1: "Shell Armor", H: "Swift Swim"},
		heightm: 1,
		weightkg: 115.5,
		color: "Green",
	...
	boltund: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 69, atk: 96, def: 69, spa: 96, spd: 69, spe: 122},
	...
	coalossal: {
		...
		types: ["Rock", "Fire"],
		gender: "M",
		baseStats: {hp: 87, atk: 82, def: 118, spa: 96, spd: 96, spe: 55},
		abilities: {0: "Steam Engine", 1: "Flame Body", H: "Flash Fire"},
		heightm: 2.8,
		weightkg: 310.5,
		color: "Black",
	...
	flapple: {
		...
		types: ["Grass", "Dragon"],
		gender: "M",
		baseStats: {hp: 60, atk: 90, def: 70, spa: 90, spd: 70, spe: 80},
	...
	appletun: {
		...
		types: ["Grass", "Dragon"],
		gender: "M",
		baseStats: {hp: 91, atk: 68, def: 103, spa: 95, spd: 96, spe: 35},
	...
	sandaconda: {
		...
		types: ["Ground"],
		gender: "M",
		baseStats: {hp: 170, atk: 40, def: 45, spa: 10, spd: 22, spe: 71},
		abilities: {0: "Sand Spit", 1: "Shed Skin", H: "Sand Veil"},
		heightm: 3.8,
		weightkg: 65.5,
		color: "Green",
	...
	cramorant: {
		...
		types: ["Flying", "Water"],
		gender: "M",
		baseStats: {hp: 70, atk: 114, def: 66, spa: 114, spd: 93, spe: 88},
	...
	barraskewda: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 61, atk: 123, def: 60, spa: 104, spd: 55, spe: 130},
		abilities: {0: "Swift Swim", H: "Propeller Tail"},
		heightm: 1.3,
		weightkg: 30,
		color: "Brown",
	...
	toxtricity: {
		...
		gender: "M",
		types: ["Electric", "Poison"],
		baseStats: {hp: 81, atk: 103, def: 75, spa: 120, spd: 85, spe: 95},
	...
	centiskorch: {
		...
		types: ["Fire", "Bug"],
		gender: "M",
		baseStats: {hp: 90, atk: 108, def: 76, spa: 105, spd: 80, spe: 75},
		abilities: {0: "Flash Fire", 1: "White Smoke", H: "Flame Body"},
		heightm: 3,
		weightkg: 120,
		color: "Red",
	...
	grapploct: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 85, atk: 118, def: 75, spa: 70, spd: 77, spe: 63},
		abilities: {0: "Limber", H: "Technician"},
		heightm: 1.6,
		weightkg: 39,
		color: "Blue",
	...
	polteageist: {
		...
		types: ["Ghost"],
		gender: "M",
		baseStats: {hp: 60, atk: 60, def: 70, spa: 110, spd: 118, spe: 70},
		abilities: {0: "Weak Armor", H: "Cursed Body"},
		heightm: 0.2,
		weightkg: 0.4,
		color: "Purple",
	...
	hatterene: {
		...
		types: ["Psychic", "Fairy"],
		gender: "F",
		baseStats: {hp: 70, atk: 95, def: 97, spa: 112, spd: 107, spe: 59},
		abilities: {0: "Healer", 1: "Anticipation", H: "Magic Bounce"},
		heightm: 2.1,
		weightkg: 5.1,
		color: "Pink",
	...
	grimmsnarl: {
		...
		types: ["Dark", "Fairy"],
		gender: "M",
		baseStats: {hp: 95, atk: 120, def: 77, spa: 65, spd: 75, spe: 67},
		abilities: {0: "Prankster", 1: "Frisk", H: "Pickpocket"},
		heightm: 1.5,
		weightkg: 61,
		color: "Purple",
	...
	obstagoon: {
		...
		gender: "M",
		types: ["Dark", "Normal"],
		baseStats: {hp: 90, atk: 115, def: 95, spa: 85, spd: 89, spe: 95},
	...
	perrserker: {
		...
		types: ["Steel"],
		gender: "M",
		baseStats: {hp: 70, atk: 109, def: 95, spa: 50, spd: 62, spe: 68},
	...
	cursola: {
		...
		types: ["Ghost"],
		gender: "M",
		baseStats: {hp: 55, atk: 70, def: 90, spa: 108, spd: 130, spe: 33},
	...
	sirfetchd: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 95, atk: 135, def: 93, spa: 51, spd: 82, spe: 65},
		abilities: {0: "Steadfast", H: "Scrappy"},
		heightm: 0.8,
		weightkg: 117,
		color: "White",
	...
	mrrime: {
		...
		types: ["Ice", "Psychic"],
		gender: "M",
		baseStats: {hp: 70, atk: 79, def: 82, spa: 99, spd: 100, spe: 72},
	...
	runerigus: {
		...
		gender: "M",
		types: ["Ground", "Ghost"],
		baseStats: {hp: 61, atk: 98, def: 120, spa: 75, spd: 99, spe: 68},
		abilities: {0: "Wandering Spirit"},
		heightm: 1.6,
		weightkg: 66.6,
		color: "Gray",
	...
	alcremie: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 65, atk: 60, def: 82, spa: 99, spd: 121, spe: 66},
		abilities: {0: "Sweet Veil", H: "Aroma Veil"},
		heightm: 0.3,
		weightkg: 0.5,
		color: "White",
	...
	falinks: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 69, atk: 100, def: 90, spa: 70, spd: 65, spe: 75},
	...
	pincurchin: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 52, atk: 88, def: 101, spa: 103, spd: 91, spe: 15},
	...
	frosmoth: {
		...
		types: ["Ice", "Bug"],
		gender: "M",
		baseStats: {hp: 70, atk: 65, def: 78, spa: 125, spd: 95, spe: 67},
		abilities: {0: "Shield Dust", H: "Ice Scales"},
		heightm: 1.3,
		weightkg: 42,
		color: "White",
	...
	stonjourner: {
		...
		types: ["Rock"],
		gender: "M",
		baseStats: {hp: 99, atk: 135, def: 145, spa: 20, spd: 18, spe: 75},
	...
	eiscue: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 70, atk: 85, def: 110, spa: 85, spd: 110, spe: 50},
	...
	eiscuenoice: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 70, atk: 110, def: 70, spa: 110, spd: 70, spe: 130},
		abilities: {0: "Ice Face"},
		heightm: 1.4,
		weightkg: 89,
		color: "Blue",
	...
	indeedee: {
		...
		gender: "M",
		baseStats: {hp: 71, atk: 60, def: 70, spa: 75, spd: 90, spe: 59},
	...
	copperajah: {
		...
		types: ["Steel"],
		gender: "M",
		baseStats: {hp: 122, atk: 130, def: 130, spa: 50, spd: 87, spe: 30},
		abilities: {0: "Sheer Force", H: "Heavy Metal"},
		heightm: 3,
		weightkg: 650,
		color: "Green",
	...
	dracozolt: {
		...
		types: ["Electric", "Dragon"],
		gender: "M",
		baseStats: {hp: 90, atk: 100, def: 100, spa: 70, spd: 90, spe: 75},
	...
	arctozolt: {
		...
		types: ["Electric", "Ice"],
		gender: "M",
		baseStats: {hp: 80, atk: 90, def: 110, spa: 70, spd: 95, spe: 58},
	...
	dracovish: {
		...
		types: ["Water", "Dragon"],
		gender: "M",
		baseStats: {hp: 73, atk: 124, def: 100, spa: 107, spd: 80, spe: 85},
	...
	arctovish: {
		...
		types: ["Water", "Ice"],
		gender: "M",
		baseStats: {hp: 90, atk: 100, def: 90, spa: 120, spd: 95, spe: 55},
	...
	duraludon: {
		...
		types: ["Steel", "Dragon"],
		gender: "M",
		baseStats: {hp: 70, atk: 95, def: 120, spa: 125, spd: 44, spe: 85},
	...
	dragapult: {
		...
		types: ["Dragon", "Ghost"],
		gender: "M",
		baseStats: {hp: 78, atk: 120, def: 75, spa: 105, spd: 75, spe: 115},
		abilities: {0: "Clear Body", 1: "Infiltrator", H: "Cursed Body"},
		heightm: 3,
		weightkg: 50,
		color: "Green",
	...
	zacian: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 100, atk: 95, def: 95, spa: 90, spd: 95, spe: 95},
	...
	zaciancrowned: {
		...
		types: ["Fairy", "Steel"],
		gender: "M",
		baseStats: {hp: 100, atk: 168, def: 115, spa: 119, spd: 115, spe: 132},
		abilities: {0: "Intrepid Sword"},
		heightm: 2.8,
		weightkg: 355,
		color: "Blue",
	...
	zamazentacrowned: {
		...
		types: ["Fighting", "Steel"],
		gender: "M",
		baseStats: {hp: 100, atk: 130, def: 145, spa: 60, spd: 145, spe: 70},
		abilities: {0: "Dauntless Shield"},
		heightm: 2.9,
		weightkg: 385,
		color: "Red",
	...
	eternatuseternamax: {
		...
		types: ["Poison", "Dragon"],
		gender: "M",
		baseStats: {hp: 100, atk: 200, def: 165, spa: 200, spd: 165, spe: 69},
		abilities: {0: "Unnerve"},
		heightm: 100,
		weightkg: 3200,
		color: "Purple",
	...
	urshifu: {
		...
		types: ["Fighting", "Dark"],
		gender: "M",
		baseStats: {hp: 100, atk: 150, def: 120, spa: 119, spd: 90, spe: 120},
	...
	zarude: {
		...
		types: ["Dark", "Grass"],
		gender: "M",
		baseStats: {hp: 100, atk: 149, def: 119, spa: 125, spd: 100, spe: 122},
		abilities: {0: "Intimidate"},
		heightm: 2.1,
		weightkg: 94,
		color: "Black",
	...
	regieleki: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 80, spa: 150, spd: 100, spe: 150},
	...
	regidrago: {
		...
		types: ["Dragon"],
		gender: "M",
		baseStats: {hp: 130, atk: 150, def: 110, spa: 100, spd: 100, spe: 90},
	...
	glastrier: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 100, atk: 145, def: 130, spa: 95, spd: 110, spe: 65},
	...
	spectrier: {
		...
		types: ["Ghost"],
		gender: "M",
		baseStats: {hp: 100, atk: 87, def: 85, spa: 145, spd: 110, spe: 129},
	...
	calyrex: {
		...
		types: ["Psychic", "Grass"],
		gender: "M",
		baseStats: {hp: 100, atk: 75, def: 105, spa: 151, spd: 145, spe: 107},
		abilities: {0: "Synchronize", H: "Magic Bounce"},
		heightm: 1.87,
		weightkg: 38.7,
		color: "Green",
	...
	wyrdeer: {
		...
		types: ["Normal", "Psychic"],
		gender: "M",
		baseStats: {hp: 85, atk: 63, def: 60, spa: 100, spd: 114, spe: 66},
		abilities: {0: "Intimidate", 1: "Frisk", H: "Sap Sipper"},
		heightm: 1.8,
		weightkg: 95.1,
		color: "Gray",
	...
	kleavor: {
		...
		types: ["Bug", "Rock"],
		gender: "M",
		baseStats: {hp: 70, atk: 130, def: 85, spa: 65, spd: 74, spe: 87},
	...
	ursaluna: {
		...
		types: ["Ground", "Normal"],
		gender: "M",
		baseStats: {hp: 130, atk: 140, def: 95, spa: 60, spd: 78, spe: 66},
	...
	ursalunabloodmoon: {
		...
		types: ["Ground", "Normal"],
		gender: "M",
		baseStats: {hp: 130, atk: 60, def: 95, spa: 140, spd: 78, spe: 66},
	...
	basculegion: {
		...
		types: ["Water", "Ghost"],
		gender: "M",
		baseStats: {hp: 120, atk: 128, def: 83, spa: 100, spd: 76, spe: 78},
	...
	sneasler: {
		...
		types: ["Fighting", "Poison"],
		gender: "M",
		baseStats: {hp: 70, atk: 120, def: 63, spa: 87, spd: 88, spe: 125},
	...
	overqwil: {
		...
		types: ["Dark", "Poison"],
		gender: "M",
		baseStats: {hp: 150, atk: 95, def: 70, spa: 50, spd: 65, spe: 65},
		abilities: {0: "Poison Point", 1: "Swift Swim", H: "Intimidate"},
		heightm: 2.5,
		weightkg: 60.5,
		color: "Black",
	...
	enamorus: {
		...
		types: ["Fairy", "Flying"],
		gender: "F",
		baseStats: {hp: 100, atk: 100, def: 70, spa: 120, spd: 80, spe: 110},
	...
	meowscarada: {
		...
		types: ["Grass", "Dark"],
		gender: "M",
		baseStats: {hp: 71, atk: 108, def: 67, spa: 92, spd: 70, spe: 123},
		abilities: {0: "Overgrow", H: "Protean"},
		heightm: 1.5,
		weightkg: 31.2,
		color: "Green",
	...
	skeledirge: {
		...
		types: ["Fire", "Ghost"],
		gender: "M",
		baseStats: {hp: 92, atk: 90, def: 92, spa: 119, spd: 86, spe: 72},
		abilities: {0: "Blaze", H: "Unaware"},
		heightm: 1.6,
		weightkg: 326.5,
		color: "Red",
	...
	quaquaval: {
		...
		types: ["Water", "Fighting"],
		gender: "M",
		baseStats: {hp: 80, atk: 120, def: 70, spa: 102, spd: 70, spe: 95},
		abilities: {0: "Torrent", H: "Moxie"},
		heightm: 1.8,
		weightkg: 61.9,
		color: "Blue",
	...
	oinkologne: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 100, atk: 80, def: 80, spa: 50, spd: 80, spe: 60},
	...
	spidops: {
		...
		types: ["Bug"],
		gender: "M",
		baseStats: {hp: 70, atk: 97, def: 88, spa: 67, spd: 84, spe: 90},
		abilities: {0: "Insomnia", H: "Stakeout"},
		heightm: 1,
		weightkg: 16.5,
		color: "Green",
	...
	lokix: {
		...
		types: ["Bug", "Dark"],
		gender: "M",
		baseStats: {hp: 70, atk: 108, def: 87, spa: 73, spd: 65, spe: 109},
		abilities: {0: "Swarm", H: "Tinted Lens"},
		heightm: 1,
		weightkg: 17.5,
		color: "Gray",
	...
	pawmot: {
		...
		types: ["Electric", "Fighting"],
		gender: "M",
		baseStats: {hp: 98, atk: 40, def: 39, spa: 15, spd: 39, spe: 79},
		abilities: {0: "Volt Absorb", 1: "Natural Cure", H: "Iron Fist"},
		heightm: 0.9,
		weightkg: 41,
		color: "Yellow",
	...
	maushold: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 80, atk: 80, def: 80, spa: 20, spd: 80, spe: 100},
	...
	dachsbun: {
		...
		types: ["Fairy"],
		gender: "M",
		baseStats: {hp: 100, atk: 80, def: 100, spa: 45, spd: 80, spe: 85},
	...
	arboliva: {
		...
		types: ["Grass", "Normal"],
		gender: "M",
		baseStats: {hp: 107, atk: 52, def: 63, spa: 98, spd: 102, spe: 49},
	...
	garganacl: {
		...
		types: ["Rock"],
		gender: "M",
		baseStats: {hp: 99, atk: 114, def: 130, spa: 69, spd: 92, spe: 65},
		abilities: {0: "Purifying Salt", 1: "Sturdy", H: "Clear Body"},
		heightm: 2.3,
		weightkg: 240,
		color: "Brown",
	...
	armarouge: {
		...
		types: ["Fire", "Psychic"],
		gender: "M",
		baseStats: {hp: 75, atk: 65, def: 100, spa: 105, spd: 95, spe: 75},
	...
	ceruledge: {
		...
		types: ["Fire", "Ghost"],
		gender: "M",
		baseStats: {hp: 70, atk: 125, def: 70, spa: 100, spd: 80, spe: 124},
		abilities: {0: "Flash Fire", H: "Weak Armor"},
		heightm: 1.6,
		weightkg: 62,
		color: "Purple",
	...
	bellibolt: {
		...
		types: ["Electric"],
		gender: "M",
		baseStats: {hp: 99, atk: 64, def: 98, spa: 109, spd: 101, spe: 45},
	...
	kilowattrel: {
		...
		types: ["Electric", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 70, def: 65, spa: 110, spd: 65, spe: 124},
		abilities: {0: "Wind Power", 1: "Volt Absorb", H: "Competitive"},
		heightm: 1.4,
		weightkg: 38.6,
		color: "Yellow",
	...
	mabosstiff: {
		...
		types: ["Dark"],
		gender: "M",
		baseStats: {hp: 90, atk: 109, def: 80, spa: 67, spd: 74, spe: 85},
	...
	grafaiai: {
		...
		types: ["Poison", "Normal"],
		gender: "M",
		baseStats: {hp: 63, atk: 90, def: 65, spa: 60, spd: 72, spe: 110},
	...
	brambleghast: {
		...
		types: ["Grass", "Ghost"],
		gender: "M",
		baseStats: {hp: 64, atk: 101, def: 65, spa: 64, spd: 70, spe: 80},
		abilities: {0: "Wind Rider", H: "Infiltrator"},
		heightm: 1.2,
		weightkg: 6,
		color: "Brown",
	...
	toedscruel: {
		...
		types: ["Ground", "Grass"],
		gender: "M",
		baseStats: {hp: 83, atk: 105, def: 65, spa: 105, spd: 90, spe: 97},
		abilities: {0: "Mycelium Might"},
		heightm: 1.9,
		weightkg: 58,
		color: "Black",
	...
	klawf: {
		...
		types: ["Rock"],
		gender: "M",
		baseStats: {hp: 70, atk: 100, def: 105, spa: 50, spd: 60, spe: 75},
	...
	scovillain: {
		...
		types: ["Grass", "Fire"],
		gender: "M",
		baseStats: {hp: 88, atk: 117, def: 88, spa: 117, spd: 88, spe: 72},
	...
	rabsca: {
		...
		types: ["Bug", "Psychic"],
		gender: "M",
		baseStats: {hp: 85, atk: 70, def: 99, spa: 115, spd: 100, spe: 73},
	...
	espathra: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 90, atk: 60, def: 65, spa: 103, spd: 70, spe: 101},
	...
	tinkaton: {
		...
		types: ["Fairy", "Steel"],
		gender: "M",
		baseStats: {hp: 62, atk: 89, def: 77, spa: 45, spd: 87, spe: 84},
		abilities: {0: "Mold Breaker", 1: "Own Tempo", H: "Pickpocket"},
		heightm: 0.7,
		weightkg: 112.8,
		color: "Pink",
	...
	wugtrio: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 65, atk: 100, def: 130, spa: 110, spd: 130, spe: 21},
		abilities: {0: "Gooey", 1: "Rattled", H: "Sand Veil"},
		heightm: 1.2,
		weightkg: 5.4,
		color: "Red",
	...
	bombirdier: {
		...
		types: ["Flying", "Dark"],
		gender: "M",
		baseStats: {hp: 70, atk: 103, def: 75, spa: 70, spd: 85, spe: 81},
	...
	palafin: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 100, atk: 95, def: 70, spa: 87, spd: 72, spe: 95},
		abilities: {0: "Swift Swim"},
		heightm: 1.3,
		weightkg: 60.2,
		color: "Blue",
	...
	palafinhero: {
		...
		types: ["Water"],
		gender: "M",
		baseStats: {hp: 100, atk: 145, def: 97, spa: 119, spd: 90, spe: 100},
	...
	revavroom: {
		...
		types: ["Steel", "Poison"],
		gender: "M",
		baseStats: {hp: 80, atk: 98, def: 107, spa: 70, spd: 67, spe: 119},
	...
	cyclizar: {
		...
		types: ["Dragon", "Normal"],
		gender: "M",
		baseStats: {hp: 70, atk: 95, def: 65, spa: 95, spd: 65, spe: 134},
	...
	orthworm: {
		...
		types: ["Steel"],
		gender: "M",
		baseStats: {hp: 60, atk: 97, def: 90, spa: 60, spd: 66, spe: 84},
	...
	glimmora: {
		...
		types: ["Rock", "Poison"],
		gender: "M",
		baseStats: {hp: 73, atk: 95, def: 90, spa: 117, spd: 85, spe: 86},
		abilities: {0: "Toxic Debris", H: "Corrosion"},
		heightm: 1.5,
		weightkg: 45,
		color: "Blue",
	...
	houndstone: {
		...
		types: ["Ghost"],
		gender: "M",
		baseStats: {hp: 64, atk: 114, def: 110, spa: 99, spd: 100, spe: 68},
	...
	flamigo: {
		...
		gender: "M",
		baseStats: {hp: 70, atk: 94, def: 74, spa: 60, spd: 64, spe: 87},
	...
	cetitan: {
		...
		types: ["Ice"],
		gender: "M",
		baseStats: {hp: 100, atk: 129, def: 103, spa: 95, spd: 92, spe: 50},
	...
	veluza: {
		...
		types: ["Water", "Psychic"],
		gender: "M",
		baseStats: {hp: 85, atk: 115, def: 73, spa: 97, spd: 74, spe: 100},
	...
	dondozo: {
		...
		gender: "M",
		types: ["Water"],
		baseStats: {hp: 130, atk: 150, def: 120, spa: 100, spd: 80, spe: 20},
	...
	tatsugiri: {
		...
		types: ["Dragon", "Water"],
		gender: "M",
		baseStats: {hp: 70, atk: 57, def: 55, spa: 141, spd: 118, spe: 120},
	...
	annihilape: {
		...
		types: ["Fighting", "Ghost"],
		gender: "M",
		baseStats: {hp: 99, atk: 115, def: 80, spa: 50, spd: 90, spe: 90},
	...
	clodsire: {
		...
		types: ["Poison", "Ground"],
		gender: "M",
		baseStats: {hp: 121, atk: 104, def: 70, spa: 95, spd: 101, spe: 50},
		abilities: {0: "Poison Point", 1: "Water Absorb", H: "Unaware"},
		heightm: 1.8,
		weightkg: 223,
		color: "Brown",
	...
	farigiraf: {
		...
		types: ["Normal", "Psychic"],
		gender: "M",
		baseStats: {hp: 99, atk: 82, def: 84, spa: 110, spd: 80, spe: 60},
	...
	dudunsparce: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 80, atk: 96, def: 80, spa: 70, spd: 67, spe: 40},
		abilities: {0: "Serene Grace", 1: "Run Away", H: "Rattled"},
		heightm: 3.6,
		weightkg: 39.2,
		color: "Yellow",
	...
	kingambit: {
		...
		types: ["Dark", "Steel"],
		gender: "M",
		baseStats: {hp: 99, atk: 135, def: 120, spa: 75, spd: 85, spe: 55},
	...
	baxcalibur: {
		...
		types: ["Dragon", "Ice"],
		gender: "M",
		baseStats: {hp: 90, atk: 113, def: 90, spa: 99, spd: 92, spe: 66},
		abilities: {0: "Thermal Exchange", H: "Ice Body"},
		heightm: 2.1,
		weightkg: 210,
		color: "Blue",
	...
	gholdengo: {
		...
		types: ["Steel", "Ghost"],
		gender: "M",
		baseStats: {hp: 70, atk: 80, def: 105, spa: 108, spd: 101, spe: 78},
	...
	wochien: {
		...
		types: ["Dark", "Grass"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 125, spa: 70, spd: 125, spe: 60},
	...
	chienpao: {
		...
		types: ["Dark", "Ice"],
		gender: "M",
		baseStats: {hp: 100, atk: 130, def: 80, spa: 120, spd: 100, spe: 120},
	...
	tinglu: {
		...
		types: ["Dark", "Ground"],
		gender: "M",
		baseStats: {hp: 100, atk: 115, def: 135, spa: 70, spd: 90, spe: 70},
	...
	chiyu: {
		...
		types: ["Dark", "Fire"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 95, spa: 150, spd: 120, spe: 102},
	...
	koraidon: {
		...
		gender: "M",
		baseStats: {hp: 100, atk: 150, def: 90, spa: 102, spd: 99, spe: 120},
	...
	miraidon: {
		...
		types: ["Electric", "Dragon"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 85, spa: 150, spd: 112, spe: 119},
	...
	dipplin: {
		...
		types: ["Grass", "Dragon"],
		gender: "M",
		baseStats: {hp: 60, atk: 35, def: 95, spa: 54, spd: 66, spe: 32},
	...
	sinistcha: {
		...
		types: ["Grass", "Ghost"],
		gender: "M",
		baseStats: {hp: 71, atk: 60, def: 86, spa: 106, spd: 86, spe: 76},
		abilities: {0: "Hospitality", H: "Heatproof"},
		heightm: 0.2,
		weightkg: 2.2,
		color: "Green",
	...
	okidogi: {
		...
		types: ["Poison", "Fighting"],
		gender: "M",
		baseStats: {hp: 100, atk: 147, def: 127, spa: 104, spd: 106, spe: 94},
	...
	munkidori: {
		...
		types: ["Poison", "Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 83, def: 80, spa: 145, spd: 110, spe: 109},
	...
	fezandipiti: {
		...
		types: ["Poison", "Fairy"],
		gender: "M",
		baseStats: {hp: 100, atk: 107, def: 91, spa: 135, spd: 122, spe: 112},
	...
	ogerpon: {
		...
		types: ["Grass"],
		gender: "F",
		baseStats: {hp: 100, atk: 122, def: 87, spa: 122, spd: 100, spe: 129},
	...
	archaludon: {
		...
		types: ["Steel", "Dragon"],
		gender: "M",
		baseStats: {hp: 95, atk: 100, def: 130, spa: 130, spd: 70, spe: 44},
	...
	hydrapple: {
		...
		types: ["Grass", "Dragon"],
		gender: "M",
		baseStats: {hp: 90, atk: 95, def: 100, spa: 120, spd: 100, spe: 50},
	...
	terapagos: {
		...
		name: "Terapagos",
		types: ["Normal"],
		baseStats: {hp: 160, atk:30, def: 88, spa: 30, spd: 88, spe: 54},
	...
	terapagosterastal: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 125, spa: 150, spd: 140, spe: 96},
	...
	terapagosstellar: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 100, atk: 130, def: 150, spa: 195, spd: 170, spe: 90},
	...
	pecharunt: {
		...
		types: ["Poison", "Ghost"],
		gender: "M",
		baseStats: {hp: 100, atk: 115, def: 80, spa: 150, spd: 108, spe: 110},
	...
	shinypikachu: {
		...
		formeOrder: [
			...
			"Shiny Pikachu-Starter", // forme 8 in LGPE
			"Shiny Pikachu-World", // Gen 8 forme (indexed as Pikachu 9 in datamine)
			"Shiny Pikachu-Rock-Star", "Shiny Pikachu-Belle", "Shiny Pikachu-Pop-Star", "Shiny Pikachu-PhD", "Shiny Pikachu-Libre", "Shiny Pikachu-Cosplay", // formes 1-6 from Gen 6
		],
		canGigantamax: "G-Max Volt Crash",
	},
	shinypikachucosplay: {
	...
	shinyfarfetchd: {
		...
		color: "Brown",
		eggGroups: ["Flying", "Field"],
		otherFormes: ["Shiny Farfetch\u2019d-Galar"],
	...
	shinykangaskhan: {
		...
		color: "Brown",
		eggGroups: ["Monster"],
		otherFormes: ["Shiny Kangaskhan-Mega"],
	...
	shinyaerodactyl: {
		...
		color: "Purple",
		eggGroups: ["Flying"],
		otherFormes: ["Shiny Aerodactyl-Mega"],
	...
	shinyarticuno: {
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Articuno-Galar"],
	...
	shinyzapdos: {
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Zapdos-Galar"],
	...
	shinymoltres: {
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Moltres-Galar"],
	...
	shinyqwilfish: {
		...
		color: "Gray",
		eggGroups: ["Water 2"],
		otherFormes: ["Shiny Qwilfish-Hisui"],
	...
	shinyheracross: {
		...
		color: "Blue",
		eggGroups: ["Bug"],
		otherFormes: ["Shiny Heracross-Mega"],
	...
	shinycorsola: {
		...
		color: "Pink",
		eggGroups: ["Water 1", "Water 3"],
		otherFormes: ["Shiny Corsola-Galar"],
	...
	shinyskarmory: {
		...
		color: "Gray",
		eggGroups: ["Flying"],
		otherFormes: ["Shiny Skarmory-Mega"],
	...
	shinysableye: {
		...
		color: "Purple",
		eggGroups: ["Human-Like"],
		otherFormes: ["Shiny Sableye-Mega"],
	...
	shinykyogre: {
		...
		tags: ["Restricted Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Kyogre-Primal"],
	...
	shinygroudon: {
		...
		tags: ["Restricted Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Groudon-Primal"],
	...
	shinyrayquaza: {
		...
		tags: ["Restricted Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Rayquaza-Mega"],
	...
	shinydialga: {
		...
		color: "White",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Dialga-Origin"],
	...
	shinypalkia: {
		...
		tags: ["Restricted Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Palkia-Origin"],
	...
	shinyheatran: {
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Heatran-Mega"],
	...
	shinygiratina: {
		...
		eggGroups: ["Undiscovered"],
		tags: ["Restricted Legendary"],
		otherFormes: ["Shiny Giratina-Origin"],
	...
	shinydarkrai: {
		...
		tags: ["Mythical"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Darkrai-Mega"],
	...
	shinyarceus: {
		...
		tags: ["Mythical"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Arceus-Bug", "Shiny Arceus-Dark", "Shiny Arceus-Dragon", "Shiny Arceus-Electric", "Shiny Arceus-Fairy", "Shiny Arceus-Fighting", "Shiny Arceus-Fire", "Shiny Arceus-Flying", "Shiny Arceus-Ghost", "Shiny Arceus-Grass", "Shiny Arceus-Ground", "Shiny Arceus-Ice", "Shiny Arceus-Poison", "Shiny Arceus-Psychic", "Shiny Arceus-Rock", "Shiny Arceus-Steel", "Shiny Arceus-Water"],
		formeOrder: [
			"Shiny Arceus", "Shiny Arceus-Fighting", "Shiny Arceus-Flying", "Shiny Arceus-Poison", "Shiny Arceus-Ground", "Shiny Arceus-Rock", "Shiny Arceus-Bug", "Shiny Arceus-Ghost", "Shiny Arceus-Steel",
			"Shiny Arceus-Fire", "Shiny Arceus-Water", "Shiny Arceus-Grass", "Shiny Arceus-Electric", "Shiny Arceus-Psychic", "Shiny Arceus-Ice", "Shiny Arceus-Dragon", "Shiny Arceus-Dark", "Shiny Arceus-Fairy",
		],
	},
	shinyarceusbug: {
		num: 493,
	...
	shinystunfisk: {
		...
		color: "Brown",
		eggGroups: ["Water 1", "Amorphous"],
		otherFormes: ["Shiny Stunfisk-Galar"],
	...
	shinytornadus: {
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Tornadus-Therian"],
	...
	shinythundurus: {
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Thundurus-Therian"],
	...
	shinylandorus: {
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Shiny Landorus-Therian"],
	...
	shinykeldeo: {
		...
		eggGroups: ["Undiscovered"],
		tags: ["Mythical"],
		otherFormes: ["Shiny Keldeo-Resolute"],
	...
	shinymeloetta: {
		...
		eggGroups: ["Undiscovered"],
		tags: ["Mythical"],
		otherFormes: ["Shiny Meloetta-Pirouette"],
	...
	shinygreninjaash: {
		...
		eggGroups: ["Undiscovered"],
		requiredAbility: "Battle Bond",
		battleOnly: "Shiny Greninja-Bond",
		gen: 7,
	},
	shinygreninjamega: {
		num: 658,
	...
	shinyfloettemega: {
		...
		battleOnly: "Shiny Floette-Eternal",
		gen: 9,
	},
	shinyflorges: {
		num: 671,
	...
	shinyhawlucha: {
		...
		color: "Green",
		eggGroups: ["Flying", "Human-Like"],
		otherFormes: ["Shiny Hawlucha-Mega"],
	...
	shinyxerneas: {
		...
		eggGroups: ["Undiscovered"],
		tags: ["Restricted Legendary"],
		otherFormes: ["Shiny Xerneas-Neutral"],
	...
	shinydiancie: {
		...
		eggGroups: ["Undiscovered"],
		tags: ["Mythical"],
		otherFormes: ["Shiny Diancie-Mega"],
	...
	shinyhoopa: {
		...
		eggGroups: ["Undiscovered"],
		tags: ["Mythical"],
		otherFormes: ["Shiny Hoopa-Unbound"],
